...
<!--<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	...
	$(document).ready(function(){
			...
			this.timer = setTimeout(function () {
				$.ajax({
		          	url: '/Exhibition/ReceiveOTPSession',
      ...
      <div class="login-container bg-white">
           ...
           <!--    </div>
                 ...
                 <div class="col-md-6 no-padding">
                    ...
                    <button type="button" class="btn btn-block btn-primary">
                      ...
                      <span>Click To Receive OTP</span>
                    </button>
        ...
        <!--     <label>Password</label> -->
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <input type="text" class="form-control" id="enteredOTP" name="enteredOTP" placeholder="Enter OTP" onblur="check()" style="text-align: center"required>
              </div> 
            </div> </div> </div>   <br>
            ...
            <!--   <div class="col-md-6 no-padding"> -->
            <!-- END Form Control-->
            <center>     <button class="btn btn-primary btn-cons m-t-10" type="submit" onclick="/Exhibition/html/exhibitionAdministratorFogotPassword.jsp" >Reset</button>
            </center>  
