          ...
          <div class="container-fluid container-fixed-lg bg-white">
            <div class="row">
              <div class="col-sm-5">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Add Exhibitions
                    </div>
                  </div>
                    <br>
                    <br>
              ...
              <div class="col-sm-7">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <form action="ckvAddexhibitionSave.jsp" method="post" actonid="form-project" role="form" autocomplete="off">
                        
                      <p>Basic Information</p>
                      <div class="form-group-attached">
                        <div class="form-group form-group-default required">
                          <label>Exhibition Name</label>
                          <input type="text" class="form-control" name="exhibitionname" required>
                        </div>
                      </div>
                        <div class="form-group form-group-default required">
                          <label>Tagline of the Exhibition</label>
                      ...
                      <div class="form-group-attached">
                        <div class="form-group form-group-default">
                         ...
                         <div class="form-group form-group-default">
                          ...
                          <input type="text" class="form-control" name="l_desc">
                        </div>
                        <div class="row clearfix">
                          <div class="col-sm-6">
                            <div class="form-group form-group-default required">
                              <label>Starting date</label>
                              <input id="start-date" type="date" class="form-control date" name="startdate" required>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group form-group-default">
                              <label>End date</label>
                              <input id="end-date" type="date" class="form-control date" name="enddate">
                            </div>
                          </div>
                        </div>
                        <div class="form-group form-group-default">
                        ...
                        <div class="form-group form-group-default">
                          ...
                          <input type="text" class="form-control" name="maplink">
                        </div>
                      </div>
                      <br>
                      <br>
