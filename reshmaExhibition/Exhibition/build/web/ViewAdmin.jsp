    ...
    <nav class="page-sidebar" data-pages="sidebar">
     ...
     <!--   <img src="assets/img/logo_white.png" alt="logo" class="brand" data-src="assets/img/logo_white.png" data-src-retina="assets/img/logo_white_2x.png" width="78" height="22">-->
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          <li class="m-t-30 ">
            <a href="/Exhibition/SuperAdminProfile.jsp" class="detailed">
     ...
     <!--             <div class="col-lg-5 col-md-6 ">
      ...
      <!--          </div> -->
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Admin Data
                </div>
                <div class="pull-right">
                  <div class="col-xs-12">
              ...
              <div class="panel-body">
                ...
                <table class="table table-hover demo-table-search" id="tableWithSearch">
                  ...
                  <%   
                         ...
                         Connection con=DriverManager.getConnection("jdbc:odbc:Exhibition","","");
                         ...
                         while(rs.next())
                         {
                            ...
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs.getString(2)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs.getString(3)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs.getString(8)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs.getString(9)+"</p></td>");
