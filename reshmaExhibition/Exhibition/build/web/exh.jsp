<%-- 
    Document   : exhibitionEvent
    Created on : Jan 27, 2016, 1:46:47 PM
    Author     : Admin
--%>
              ...
              <div class="col-md-6">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="panel-title"> Events Info
                    </div>
                  ...
                  <div class="col-sm-6">
                      <form id="form-work" class="form-horizontal" role="form" autocomplete="off">
                          <div class="form-group">
                              <label for="fname" class="col-sm-4 "><b> Events </b></label>
                        <div class="col-sm-7">
                            <input type="text"  id="fname" placeholder="" name="name" disabled><br>
                        </div>
                      </div>
                           
                           <div class="form-group">
                               <label for="fname" class="col-sm-4"> <b> Description </b> </label>
                        <div class="col-sm-7">
                            <input type="text"  id="fname" placeholder="" name="name" disabled><br>
                        </div>
                      </div>
                           <div class="form-group">
                               <label for="fname" class="col-sm-4 "> <b> Timing </b> </label>
                        <div class="col-sm-7">
                            <input type="text"  id="fname" placeholder="" name="name" disabled><br>
                        </div>
                      </div>
                           <div class="form-group">
                               <label for="fname" class="col-sm-4"> <b>  Venue </b> </label>
                        <div class="col-sm-8">
                            <input type="text"  id="fname" placeholder="" name="name" disabled><br>
                        </div>
                      </div>
              ...
              <div class="col-md-6">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    ...
                    <div class="bg-pic">
        <img src="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src-retina="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" alt="" class="lazy" height="350px" width="550px">
