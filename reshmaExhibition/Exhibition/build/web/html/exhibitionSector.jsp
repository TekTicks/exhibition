  ...
  <div class="page-content-wrapper ">
   ...
   <div class="content ">
          ...
          <div class="panel-body">
                      <h5> <font color="red"> Add Exhibition Sector </font>
                      </h5>  <br>
                      <form class="" role="form" action="exhibitionSectorInsertDb.jsp" method="post">
                      ...
                      <div class="form-group form-group-default required">
                       ...
                       <button class="btn btn-success" type="submit" onclick="exhibitionSectorInsertDb.jsp">Add</button>
