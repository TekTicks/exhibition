<%-- 
    Document   : exhibitionOpportunity
    Created on : Jan 27, 2016, 4:42:15 PM
    Author     : Admin
--%>
  ...
  <div class="page-content-wrapper ">
   ...
   <div class="content ">
           <div class="container-fluid container-fixed-lg">
              <h2><font color="red"> Opportunity / Responses</font> </h2>
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row clearfix">
                       <div class="form-group form-group-default required">
                                  ...
                                  <input type="text" id="opportunityTitle" name="opportunityTitle" class="form-control" required>
                                </div>
                               </div>  
                            <div class="form-group form-group-default required">
                              <label>email</label>
                          ...
                          <br>
                     <button class="btn btn-danger" type="submit" onclick="exhibitionAddressInsertDb.jsp">Add</button>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <form class="" role="form">
                      ...
                      <div class="form-group form-group-default required">
                        <label>Message</label>
                        <input type="password" id="message" name="message" class="form-control" required>
                      </div>
                      <div class="form-group  form-group-default required">
                        <label>Created On</label>
                        <input type="email" id="createdOn" name="createdOn" class="form-control" placeholder="" required>
                      </div> 
                     <button class="btn btn-danger" type="submit" onclick="exhibitionAddressInsertDb.jsp">Add</button>
                          <button class="btn btn-default"><i class="pg-close"></i> Clear</button>
                    </form>
