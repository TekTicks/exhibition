                                ...
                                if(msg != 'ERROR') // Message Sent, check and redirect
				{
                                               	...
                                               	$("#msgbox2").fadeTo(200,0.1,function() //start fading the messagebox
		                {
			                 ...
			                 $(this).html('Sorry, Wrong Password.').removeClass().addClass('myerror').fadeTo(900,1);
                                        // document.location='/Exhibition/html/exhibitionAdminLog.jsp';
                                 });
            ...
            <div class="row">
              ...
              <!--    <input type="checkbox" value="1" id="checkbox1">
                  <label for="checkbox1">Keep Me Signed in</label>-->
                                  <a href="/Exhibition/html/enterMobileNo.jsp" class="text-info small">Forgot Password..?</a>
