<%-- 
    Document   : exhibitionSocialMedia
    Created on : Jan 27, 2016, 4:55:22 PM
    Author     : Admin
--%>
          ...
          <div class="container-fluid container-fixed-lg">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <h5> <font color="red"> Exhibition Social Media </font>
                      </h5>  <br>
                    <form class="" role="form" action="exhibitionSocialMediaInsertDb.jsp" method="post">
                      <div class="form-group form-group-default required ">
                        ...
                        <input type="text" id="exhibitionId" name="exhibitionId" class="form-control" required>
                          ...
                          <button class="btn btn-success" type="submit" onclick="exhibitionSocialMediaInsertDb.jsp">Add</button>
