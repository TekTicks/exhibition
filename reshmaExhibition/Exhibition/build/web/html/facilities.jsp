<%-- 
    Document   : facilities
    Created on : Jan 27, 2016, 4:12:25 PM
    Author     : Admin
--%>
...
<html>
  ...
  <div class="page-content-wrapper ">
   ...
   <div class="content ">
          ...
          <div class="panel panel-default bg-success-light" data-pages="portlet">
                        ...
                        <p class="text-white"> 
                            ...
                            <div class="leftfloat">
                                <form role="form">
                                    ...
                                    <label><h3 class="text-white"> <b> Food Arrangement : hall no. 605<b> </h3></label> <br>
                                
                                    
                              
                                                    <label><h3 class="text-white"><b> Sitting Arrangement : hall no. 604</b> </h3> </label> <br>
