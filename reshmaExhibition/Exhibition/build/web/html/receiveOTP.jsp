	       ...
	       // $("#msgbox").removeClass().addClass('myinfo').text('Validating Your Login ').fadeIn(1000);
			...
			this.timer = setTimeout(function () {
				$.ajax({
		          	...
		          	data: 'un='+ $('#enteredOTP').val(),
		          	type: 'post',
		   		success: function(msg){
                                  
                                if(msg != 'ERROR') // Message Sent, check and redirect
				{
                                          $("#msgbox1").html('OTP MATCH.').addClass('myinfo').fadeTo(900,1,function()
			             {
					...
					$("#msgbox1").fadeTo(100,1,function() //start fading the messagebox
		                {
			                 ...
			                 $(this).html('Sorry, OTP INVALID').removeClass().addClass('myerror').fadeTo(300,1);
                                         document.location='/Exhibition/html/enterMobileNo.jsp?user';
                                 });
                                }
				}
   ...
   <body class="fixed-header   ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
         ...
         <p class="p-t-35"><h2><b> Enter OTP To Verify </b></h2>
          <!-- START Login Form -->
         <form name="login_frm" id="login_frm" action="" method="post" class="p-t-15" >
            ...
            <!-- END Form Control-->
            <button class="btn btn-primary btn-cons m-t-10" name="login" id="login"  type="submit" onclick="checkOTP()"> Reset</button>
