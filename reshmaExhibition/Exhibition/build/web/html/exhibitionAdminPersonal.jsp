		...
		$("#login").submit(function(){
	       ...
	       // $("#msgbox").removeClass().addClass('myinfo').text('Validating Your Login ').fadeIn(1000);
			...
			this.timer = setTimeout(function () {
				$.ajax({
		          	url: '/Exhibition/ExhibitionAdminPersonal',
                                ...
                                if(msg != 'mobileNoInvalid') // Message Sent, check and redirect
				{
                                        if(msg=='ok')
                                        {
                                          $("#msgbox1").html('data updated').addClass('myinfo').fadeTo(900,1,function()
			             {
                    ...
                    <div class="notification-panel">
                      ...
                      <div class="notification-body scrollable">
                        ...
                        <div class="notification-item unread clearfix">
                          ...
                          <div class="option" data-toggle="tooltip" data-placement="le ft" title="mark as read">
                            <a href="#" class="mark"></a>
                          </div>
          ...
          <div class="container-fluid container-fixed-lg">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title"> Personal Information
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <!--  <h3>Create Moderator</h3> -->
                    ...
                    <form id="login" name="login" class="form-horizontal" role="form" autocomplete="off" action="" method="">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="mobileNo" name="mobileNo" placeholder="mobile No " value="  <%
                            out.print(global.personalInformation.mobileNoPI);
                        %>" required>
                       </div>
                       <div id="msgbox2"> </div>
                      </div>
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<%out.print(global.Global.un);%>" required>
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="userName" placeholder="username" name="userName" value="<%out.print(global.personalInformation.userNamePI);%>" required>
                        </div>
                      </div>
                           <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Password</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="password" placeholder="password" name="password"  value="<%out.print(global.Global.pwd);%>" required >
                        </div></div>
                    
                        <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Level</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="level" placeholder="level" name="level" value="<%out.print(global.personalInformation.levelPI);%>" onkeyup="validate()" required>
                        </div>
                      </div>   
                        
                        <br><div id="msgbox1"> </div><div id="msgbox2"> </div>
                      <div class="row">
                        <div class="col-sm-3">
