...
public final class receiveOTP_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t$.ajax({\n");
      out.write("\t\t          \turl: '/Exhibition/ReceiveOTPSession',\n");
      out.write("\t\t          \tdata: 'un='+ $('#enteredOTP').val(),\n");
      out.write("\t\t          \ttype: 'post',\n");
      out.write("\t\t   \t\tsuccess: function(msg){\n");
      out.write("                                  \n");
      out.write("                                if(msg != 'ERROR') // Message Sent, check and redirect\n");
      out.write("\t\t\t\t{\n");
      out.write("                                          $(\"#msgbox1\").html('OTP MATCH.').addClass('myinfo').fadeTo(900,1,function()\n");
      out.write("\t\t\t             {\n");
      out.write("\t\t\t                 //redirect to secure page\n");
      out.write("\t\t\t                 document.location='/Exhibition/html/exhibitionAdministratorFogotPassword.jsp';\n");
      out.write("\t\t\t             });\n");
      out.write("                                        \n");
      out.write("                                   }\n");
      out.write("\t\t\t\telse\n");
      ...
      out.write("\t\t\t                 $(this).html('Sorry, OTP INVALID').removeClass().addClass('myerror').fadeTo(300,1);\n");
      out.write("                                         document.location='/Exhibition/html/enterMobileNo.jsp?user';\n");
      out.write("                                 });\n");
      out.write("                                }\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("         <p class=\"p-t-35\"><h2><b> Enter OTP To Verify </b></h2>\n");
      ...
      out.write("           \n");
      out.write("            <!-- END Form Control-->\n");
      out.write("            <button class=\"btn btn-primary btn-cons m-t-10\" name=\"login\" id=\"login\"  type=\"submit\" onclick=\"checkOTP()\"> Reset</button>\n");
      out.write("            \n");
      out.write("\n");
      out.write("          </form>\n");
