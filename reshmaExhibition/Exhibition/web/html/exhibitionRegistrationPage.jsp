<%-- 
    Document   : exhibitionRegistrationPage
    Created on : Jan 27, 2016, 12:08:59 PM
    Author     : Admin
--%>
          ...
          <!--  <span class="details">19 items</span>  -->
           ...
           <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              <ul class="sub-menu">
                 <li class="">
                <a href=""> Add Sectors </a>
                <span class="icon-thumbnail">c</span>
              </li>
              <li class="">
                <a href=""> Add Exhibition Team</a>
                <span class="icon-thumbnail">c</span>
              </li>
              <li class="">
                <a href="">Add Exhibition Social Media</a>
                <span class="icon-thumbnail">L</span>
              </li>
              <li class="">
                <a href="">Add Exhibition Address </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href="">Opportunities/Response </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href=""> FAQ's </a>
               ...
               <li class="">
                <a href=""> Exhibition Speakers  </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href="">Photos/Videos/Blogs</a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
      ...
      <div class="container-sm-height full-height">
        <div class="row row-sm-height">
          <div class="col-sm-12 col-sm-height col-middle">
              <h2> <font color="red"> Create Exhibition Registration Page </font> </h2>
              <br>
            <p>
            ...
            <!--  <div class="row m-t-10">
              ...
              <button class="btn btn-primary btn-cons m-t-10" type="submit">Register Exhibition</button>
            </form>
          </div>
        </div>
      </div>
