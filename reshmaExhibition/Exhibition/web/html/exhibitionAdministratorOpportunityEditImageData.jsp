...
try{
      ...
      HttpSession fs=request.getSession();
       String idr=(String)fs.getAttribute("idr");     
        HttpSession ss=request.getSession();
...
psmnt.setString(1, "");
 ...
 String que="update exhibitionOpportunity set exhibitionId='"+exId+"', opportunityTitle='"+title+"', email='"+email+"',mobile='"+mobile+"', contactNo='"+contactNo+"',mediaId='"+iddsf+"',mobileCountryId='"+mobileCountryId+"',contactCountryId='"+contactCountryId+"' where id='"+idr+"' ";
 PreparedStatement ps=con2.prepareStatement(que);
