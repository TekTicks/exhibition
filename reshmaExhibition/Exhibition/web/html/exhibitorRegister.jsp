	       ...
	       // $("#msgbox").removeClass().addClass('myinfo').text('Validating Your Login ').fadeIn(1000);
			...
			this.timer = setTimeout(function () {
				$.ajax({   
		          	...
		          	data: 'companyName='+ $('#companyName').val() +'&userName=' + $('#userName').val()+'&email=' + $('#email').val() +'&password=' + $('#password').val()+'&cpassword=' + $('#cpassword').val()+'&countryId=' + $('#countryId').val()+'&mobileNo=' + $('#phone').val() +'&checkbox2=' + $('#checkbox2').val(),
		          	type: 'post',
              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="countryId" id="countryId">
                       ...
                       <optgroup label="Select id">
                         ...
                         %>
                        <option class="full-width" value="<%=id1%>"><%out.print(rsy.getString(4));%></option>
                         <%   
                         }
                        } 
                   catch(Exception e) 
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                      <label>Is Main Exhibitor</label></div></div> </div> 
                 <div class="checkbox check-primary  ">
                      <input type="checkbox" name="isMainEx" id="checkbox2">
              ...
              <div class="row m-t-10">
                ...
                <div class="col-md-6 text-right">
                  <a href="#" class="text-info small">Help? Contact Support</a>
                        ...
                        <button class="btn btn-primary btn-cons m-t-10" type="submit">Create a new account</button><br><br><br>
            </form>
          </div>
        </div>
      </div>
