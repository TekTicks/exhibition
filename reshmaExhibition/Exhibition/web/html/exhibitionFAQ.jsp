<%-- 
    Document   : exhibitionFAQ
    Created on : Jan 27, 2016, 4:23:10 PM
    Author     : Admin
--%>
...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Pages - Admin Dashboard UI Kit - Tabs and Accordians</title>
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg">
              <div class="panel-header"> <h1><font color="blue"> <b> FAQ </b> </font> </h1> </div>
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-heading" role="tab" id="headingOne">
                        ...
                        <h4 class="panel-title">
                            ...
                            HOW LONG DOES IT TAKE TO SET UP AN ONLINE REGISTRATION PAGE?
                            </a>
                          </h4>
                      </div>
                      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                         Once Exhibition & Event Services have received the artwork a standard registration page can take approximately 2 hours. If it is a customised site, then it will take a few days.
                        </div>
                      </div>
                    </div>
                    <div class="panel panel-default">
                     ...
                     HOW DO I KNOW HOW MY PRE-REGISTRATION PROCESS IS PROGRESSING?  </a>
                          </h4>
                      </div>
                      <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                          Exhibition & Event Services will give you a password enabling you to access the bank end to the website to see how your pre-registrations are progressing.
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                          Don't just wait for people to come to your registration page - We can email your database with a link to a pre-populated form filling many of the fields for the visitor. In controlled trials, 50% more respond to Pre-filled forms than to ordinary email shots.
                        </div>
                      </div>
                    </div>
                  </div>
