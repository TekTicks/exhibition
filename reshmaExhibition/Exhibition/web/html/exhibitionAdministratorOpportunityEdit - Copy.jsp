 ...
 <p><h1><b> Update Opportunities...!</b></h1></p>
          ...
          <form action="exhibitionAdministratorOpportunityEditImageData.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                 <% 
                      try { 
                             ...
                             while(rs.next())
                             {
                            HttpSession Ig=request.getSession(true);
                             String ccId=rs.getString("contactCountryId");
                              Ig.setAttribute("ccId", ccId);    
                             String mcId=rs.getString("mobileCountryId");
                              Ig.setAttribute("mcId", mcId);    
                             String mediaId=rs.getString("mediaId"); 
                             Ig.setAttribute("mediaId", mediaId);    
                             %> 
              ...
              <div class="form-group ">
                    ...
                    try { 
                          // Class.forName("com.mysql.jdbc.Driver"); 
                           ...
                           ResultSet rs1=stat2.executeQuery("select * from exhibitionAdmin");
                           int count1=0;
                     %>
                    ...
                    <div class="form-group">
                        <label>Title</label>
                      <input type="text" class="form-control" value=" <%out.print(rs.getString("Opportunitytitle"));%>" id="title" name="title" required>
                      </div>         
                            <div class="form-group">
                        <label>Email</label>
                      <input type="email" class="form-control" id="email"  value="<%out.print(rs.getString("email"));%>" name="email" required>
                      </div>          
                         <div class="form-group">  
                        <label>Mobile No</label>
                          <div class="row">
                                 ...
                                 <%    
                    try { 
                           //HttpSession Ig=request.getSession(false);
                           String mci=(String)Ig.getAttribute("mcId");
                           Connection con34;
                           con34 = exhibitionAdministratorOneTimeConnection.getConnection(); 
                           Statement sta34=con34.createStatement();
                           ResultSet rsy34=sta34.executeQuery("select * from country where id='"+mci+"' ");
                            int cou1=0;
                           %>
                        <select class="full-width" data-init-plugin="select2" name="mobileCountryId" id="mobileCountryId">
                          ...
                          <%
                            while(rsy34.next())
                       { 
                         String r34=rsy34.getString(1);
                        
                         %>
                         
                          <option value="<%= r34%>"><%out.print(rsy34.getString(4));%></option>
                    ...
                    try { 
                           ...
                           Connection con4;
                           con4 = exhibitionAdministratorOneTimeConnection.getConnection(); 
                           Statement sta4=con4.createStatement();
                           ResultSet rsy4=sta4.executeQuery("select * from country ");
                           int cou1=0;
                    while(rsy4.next())
                         { 
                         
                            String rst4=rsy4.getString(1);
                         %>
                     
                              <option value="<%= rst4%>">  <%out.print(rsy4.getString(4));%></option> 
                               <%   
                         }
                        } 
                   catch(Exception e) 
                      ...
                      out.print("error" +e); 
                        ...
                        %>  
                              ...
                              <div class="col-sm-8">
                          <input type="text" class="form-control" id="mobile" value="<%out.print(rs.getString("mobile"));%>" name="mobile" value="" required>
                              </div>
                    ...
                    try { 
                          ...
                          String ccId1=(String)Ig.getAttribute("ccId");
                           Connection con6;
                           con6= exhibitionAdministratorOneTimeConnection.getConnection(); 
                           Statement sta6=con6.createStatement();
                           ResultSet rsy6=sta6.executeQuery("select * from country where id='"+ccId1+"'");
                           int cou1=0;
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="contactCountryId" id="contactCountryId">
                         ...
                         <% while(rsy6.next())
                         { 
                           String r2=rsy6.getString(1);
                        
                         %>
                        <option value="<%= r2%>"><%out.print(rsy6.getString(4));%></option>
                         <%   
                         }
                        } 
                   catch(Exception e) 
                    ...
                    try { 
                           ...
                           Connection con7;
                           con7= exhibitionAdministratorOneTimeConnection.getConnection(); 
                           Statement sta7=con7.createStatement();
                           ResultSet rsy7=sta7.executeQuery("select * from country ");
                           int cou1=0;
                    while(rsy7.next())
                         { 
                         
                            String rst7=rsy7.getString(1);
                         %>
                     
                       
                              <option value="<%= rst7%>"> <%out.print(rsy7.getString(4));%></option> 
                               <%   
                         }
                        } 
                   catch(Exception e) 
                      ...
                      out.print("error" +e); 
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="contactNo" value="<%out.print(rs.getString("contactNo"));%>" name="contactNo" required>
                        </div> </div></div> <br>
          ...
          <input name="userImage" type="file" class="inputFile" onchange="readURL(this);"  /><br> 
                      ...
                      try { 
                             ...
                             Connection con8;
                             con8=exhibitionAdministratorOneTimeConnection.getConnection(); 
                             Statement stat8=con8.createStatement();
                              String media=(String)Ig.getAttribute("mediaId");
                             
                             String q="select * from media where id= '"+media+"' " ;
                             ResultSet rs8=stat8.executeQuery(q); 
                             int u=0;
                            while(rs8.next()) {
                          ...
                          <script type="text/javascript">
									...
									reader.readAsDataURL(input.files[0]);
                                                                        ...
                                                                        <img src="images/<%=rs8.getString("link")%>" id="tempImg"  width="125" height="125" > 
