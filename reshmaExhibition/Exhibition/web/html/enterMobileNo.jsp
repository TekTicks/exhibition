		...
		$("#login_frm").submit(function(){
			...
			this.timer = setTimeout(function () {
                                ...
                                if(msg != 'ERROR') // Message Sent, check and redirect
				{
			                 ...
			                 $(this).html('invalid mobile no').removeClass().addClass('myerror').fadeTo(300,1);
                                    ...
                                    {
                                          $("#msgbox1").html('Mobile no Verified.....').addClass('myinfo').fadeTo(900,1,function()
			             {
				...
				else
				{
					$("#msgbox3").fadeTo(200,1,function() //start fading the messagebox
		                {
			                  //add message and change the class of the box and start fading
			                 $(this).html('Sorry, Wrong Mobile NO').removeClass().addClass('myerror').fadeTo(300,1);
