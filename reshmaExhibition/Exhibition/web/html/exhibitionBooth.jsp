<%-- 
    Document   : exhibitionBooth
    Created on : Jan 27, 2016, 4:07:25 PM
    Author     : Admin
--%>
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <!--  <h3>Create Moderator</h3> -->
                    ...
                    <br>
                    <p class="small hint-text"> Add Booths
                      <br></p>
                    <form id="form-work" class="form-horizontal" role="form" autocomplete="off">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Booth Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="fname" placeholder="first name" name="name" required>
                        </div>
                      </div>
                        <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label"> Social Media ID</label>
                        <div class="col-sm-9">
