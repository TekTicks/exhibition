<%-- 
    Document   : createNews
    Created on : Jan 28, 2016, 12:06:34 PM
    Author     : Admin
--%>
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <!--  <h3>Create Moderator</h3> -->
                    ...
                    <br>
                    <p class="small hint-text"> Create News
                      <br></p>
                    <form id="form-work" class="form-horizontal" role="form" autocomplete="off">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">News Heading</label>
                        <div class="col-sm-9">
