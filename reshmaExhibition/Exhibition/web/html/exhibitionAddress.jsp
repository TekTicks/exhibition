<%-- 
    Document   : exhibitionAddress
    Created on : Jan 27, 2016, 4:43:54 PM
    Author     : Admin
--%>
              ...
              <div class="panel-body sortable">
                <div class="row">
                    ...
                    <div class="panel panel-default bg-success" data-pages="portlet">
                      <div class="panel-heading">
                          <div class="panel-title"><h4 class="text-white"> Add exhibition Address </h4>
                        </div> 
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                            <form role="form" action="exhibitionAddressInsertDb.jsp" method="post">
