<%-- 
    Document   : visitorConnect
    Created on : Jan 28, 2016, 11:57:21 AM
    Author     : Admin
--%>
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
                ...
                <li class="m-t-30 ">
            <a href="exhibitorDashboard.jsp" class="detailed">
          ...
          <!--  <span class="details">19 items</span>  -->
            ...
            <span class="icon-thumbnail">p</i></span>
             ...
             <li>
            <a href="representatives.jsp"><span class="title">Representatives</span>
           </a>
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              <ul class="sub-menu">
                 <li class="">
                <a href="createProduct.jsp">Create Products</a>
          ...
          <li>
            <a href="brochures.jsp"><span class="title">Brochures</span>
           </a>
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
           ...
           <li>
            <a href="javascript:;"><span class="title">News</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
            <ul class="sub-menu">
                 <li class="">
          ...
          <li>
            <a href="exhibitorVisitorConnect.jsp"><span class="title">Visitor Connect</span>
            </a>
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
          ...
          <li class="">
            <a href="exhibitorReport.jsp"><span class="title">Reports</span>
            </a>
           ...
           <div class="row">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                      <div class="panel-title"> <h4> <b><font color="green"> Feedback </font> <b> </h4>
                    </div>
                  </div>
                  <div class="panel-body">
                    ...
                    <br>
                    <button class="btn btn-primary btn-cons m-b-10" type="button"> <span class="bold">Visited</span>
                    </button>
                    <!-- Indicates a successful or positive action -->
                    <button class="btn btn-success btn-cons m-b-10" type="button"> <span class="bold">Liked </span>
                    </button>
                    <!-- Contextual button for informational alert messages -->
                    <button class="btn btn-danger btn-cons m-b-10" type="button"> <span class="bold">Favorites</span>
                    </button>
