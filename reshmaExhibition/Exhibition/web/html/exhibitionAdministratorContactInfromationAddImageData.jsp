...
psmnt.setString(1, "");
 ...
 PreparedStatement ps=con2.prepareStatement("update exhibitionAdminContact set title=?,firstName=?,lastName=?,dateOfBirth=?,level=?,degination=?,phoneNo=? where id='"+idValid+"'");
