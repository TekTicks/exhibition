...
<html>
  <head>
    ...
    <!-- PLUGINS FOR DELETE CONFIRMATION -->
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
                <div class="tab-pane slide-left padding-20" id="tab1">
                  <div class="row row-same-height">
                      ...
                      <!-- START PANEL -->
                     <form ENCTYPE="multipart/form-data" action="/Exhibition/html/imageUpload.jsp" method="post" role="form" name="form1" id="form1">
                           ...
                           <div class="form-group form-group-default input-group required">
                            ...
                            <select class="cs-select cs-skin-slide cs-transparent" name="ccodePrimary" id="ccodePrimary" data-init-plugin="cs-select" disabled>
                             ...
                             %>
                              ...
                              <input type="text" name="p_contact"  onkeypress="return validate(event)" value="<%out.print(rs5.getString(7));%>" id="p_contact" maxlength="10" minlength="10" class="form-control" placeholder="" disabled>
                          </div>
                        ...
                        <input type="text" name="s_contact" maxlength="10"  onkeypress="return validate(event)"  minlength="10" value="<%out.print(rs5.getString(8));%>"  id="s_contact" class="form-control" placeholder="" >
                        </div>
