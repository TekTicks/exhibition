            ...
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="panel-body no-padding">
                        <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorProductAdd.jsp';"><i class="fa fa-plus"></i> Add Product
                         </button>
                    </div>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="panel-body">
                <table class="table table-hover demo-table-search" id="tableWithSearch">
                    ...
                    <%   
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from exhibitorProducts where createdBy='"+productIdd+"'");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             ...
                             <td>
                                <div class="btn-group">
                                <button  type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorProductEdit.jsp?pId=<%= kv %>';"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/exhibitorProductDelete?pId=<%=kv%>"><i class="fa fa-trash-o"></i> </button>  
                                </div>          
                             </td>
