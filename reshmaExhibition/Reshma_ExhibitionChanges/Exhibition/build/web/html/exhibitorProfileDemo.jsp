...
try{
 ...
 PreparedStatement ps=con.prepareStatement("update exhibitorProfile a,exhibitor b set b.companyName=?,a.primEmail=?,a.secEmail=?,a.primContact=?,a.secContact=?,a.primCountryCodeId=?,a.secCountryCodeId=?,a.about=?, a.website=?,a.logoMediaId=? where a.createdBy='"+idd+"' ");
