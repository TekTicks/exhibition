...
<html>
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="/Exhibition/html/exhibitionSpeakerView.jsp">Photos/Videos/Blogs</a>
                <span class="icon-thumbnail">M</span>
              </li>
                <li class="">
                <a href="/Exhibition/html/exhibitionAlbumView.jsp">News</a>
                <span class="icon-thumbnail">M</span>
              </li>
              <li class="">
  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
  ...
  </p> --><p><h1><b>Add Exhibition Booth..!</b></h1></p>
          <br>
         
              <form action="exhibitionAddBoothImage.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                      
                    
                       
                          <div class="form-group form-group-default required">
                            <label>Booth Name</label>
                            <input type="text"   id="boothName" name="boothName" class="form-control" required>
                          </div>
	...
	<img id="tempImg"  src="" width="125" height="125"> 
                      ...
                      <br>      
                         ...
                         <button class="btn btn-success" type="button" onclick="document.location.href='/Exhibition/html/exhibitionBoothView.jsp';">Cancel</button>
