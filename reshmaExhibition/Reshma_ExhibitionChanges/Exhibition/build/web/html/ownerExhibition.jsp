        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <center> <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                        <a class="btn btn-success btn-ok">Yes</a> </center>
                </div>
            </div>
        </div>
      </div>
          ...
          <div class="visible-lg visible-md m-t-10">
            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                <%
                      ...
                      ResultSet rs0=st0.executeQuery("select * from ownerProfile where createdBy='"+ownerId+"'");
                      int col0=0;
                      while(rs0.next())
                      {
                  %> 
            ...
            <div class="dropdown pull-right">
              <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <%
                    ...
                    ResultSet rs01=st01.executeQuery("select * from ownerProfile where id='"+ownerId1+"'");
                    int cot01=0;
                    while(rs01.next())
                    {
                  ...
                  <br><div class="row">
                    <div class="col-sm-12">
                      <div class="form-group form-group-default">
                        ...
                        <input type="text" name="exhibitionName" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="panel-heading">
                ...
                <div class="pull-right">
                 <div class="panel-body no-padding">
                     <button  class="btn btn-primary btn-cons" id="btnToggleSlideUpSize" ><i class="fa fa-plus"></i> Add Exhibitions </button>
                 </div>
                </div>
                <div class="clearfix"></div>
              </div>
                  ...
                  <tbody>
                    <%   //Retrieve onwerId from session 
                         ...
                         while(rs1.next())
                         {
                            ...
                            out.println("<tr >");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs1.getString(18)+"</p></td>");
                    ...
                    %>
                             ...
                             <td>
                                 <div class="btn-group">
                                 <!-- <button  type="button" class="btn btn-success btn-cons m-b-10" onclick="document.location.href='/Exhibition/html/ownerEditExhibition.jsp?exhibitionId=<%= kv %>';"><i class="fa fa-pencil"></i></button> -->
                                 <button type="button" class="btn btn-success btn-cons m-b-10"  data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/html/ownerEditExhibition.jsp?exhibitionId=<%= kv %>"><i class="fa fa-pencil" ></i> </button>      
                                 </div>
                            </td><%
                            out.println(" </tr>");
                        }
