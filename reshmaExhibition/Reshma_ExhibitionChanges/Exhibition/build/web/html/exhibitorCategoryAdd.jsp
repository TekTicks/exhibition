    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
         ...
         <form action="/Exhibition/exhibitorCategoryAdd" method="post" role="form">
                    ...
                    <div class="padding-30">
                        <br>
                              <div class="form-group required">
                                ...
                                <textarea id="wysiwyg5" class="wysiwyg demo-form-wysiwyg" name="desc" placeholder="Enter text ..."></textarea>
                                </div>
                                </div>
                              <br>
                              <br>
                              ...
                              <button class="btn btn-primary btn-cons m-t-10" onclick="document.location.href='/Exhibition/html/exhibitorCategory.jsp';"> Cancel</button> 
                          </div>
                          </div>    
