	...
	<img id="tempImg"  src="images/<%out.print(rso.getString("link"));%>" width="200" height="200"> 
     ...
     <%
       ...
       <button class="btn btn-primary btn-cons m-t-10" type="submit"> Update </button>
          <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/exhibitionAdministratorSector.jsp';"> Cancel </button>
