         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="exhibitionBoothView.jsp">Add Booths </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href="exhibitionEventView.jsp">Exhibition Event</a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href="exhibitionSpeakerView.jsp"> Exhibition Speakers  </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
                <a href="exhibitionAlbumView.jsp">Photos/Videos/Blogs</a>
                <span class="icon-thumbnail">M</span>
              </li>
                <li class="">
         ...
         <div class="content ">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br> 
                    <div class="panel-title"> <h4> View Exhibitors</h4>
                </div>
                    <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorRegister.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                      ...
                      <%
                       ...
                       Connection con;
                        con=dbConnection.getConnection();
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from exhibitor");
                         int count1=0;
                        ...
                        out.println("<td class='v-align-middle semi-bold'><p>"+rs1.getString(5)+"</p></td>");
                           ...
                           %>
                             <td>
                                ...
                                <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorEdit.jsp?exid=<%=exid%>';"><i class="fa fa-pencil"></i></button>
