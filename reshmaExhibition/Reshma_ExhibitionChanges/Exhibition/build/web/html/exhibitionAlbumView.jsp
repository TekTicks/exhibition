        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success btn-ok" onclick="document.location.href='/Exhibition/exhibitionAlbumDelete';">Delete</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="confirm-delete1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-success btn-ok" onclick="document.location.href='/Exhibition/exhibitionAlbum_media Delete';">Delete</a>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="page-content-wrapper ">
          ...
          <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>View Albums</span></a>
                </li>
                
                <li class="">
                  <a data-toggle="tab" href="#tab2"><i class="fa fa-truck tab-icon"></i> <span> Add Photos</span></a>
                </li>
          ...
          <div class="tab-pane slide-left padding-20" id="tab1">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                    <div class="panel-title"> <h4> View Exhibition Album </h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAddAlbum.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                    ...
                    <%   
                      ...
                      Connection con;
                        con=dbConnection.getConnection();
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from exhibitionAlbum");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             <td>
                                 ...
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitionAlbumEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/exhibitionAlbumDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i>
                                 </button>
        ...
        $('#confirm-delete').on('show.bs.modal', function(e) {
          ...
          <!-- END CONTAINER FLUID -->
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                    <div class="panel-title"> <h4> View Exhibition Album Photo </h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAddAlbumPhoto.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                    ...
                    <%   
                      ...
                      Connection con5;
                        con5=dbConnection.getConnection();
                         ...
                         ResultSet rs5=stat5.executeQuery("select * from exhibitionAlbum_media");
                         int count5=0;
                         ...
                         { 
                            count5++;
                            out.println("<tr>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs5.getString(2)+"</p></td>");
                             // out.println("<td class='v-align-middle semi-bold'><p>"+rs1.getString(3)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs5.getString(4)+"</p></td>");
                  
                            String exid=rs5.getString(1);
                           // HttpSession sO=request.getSession(true);
                           // s.setAttribute("myid", exid);
                            //out.print(exid);
                           %>
                             <td>
                                 ...
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitionAlbumPhotoEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/exhibitionAlbumPhotoDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete1"><i class="fa fa-trash-o"></i>
                                 </button>
