<%-- 
    Document   : ddd
    Created on : Mar 29, 2016, 4:12:54 AM
    Author     : Admin
--%>
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="/Exhibition/html/404.html">Add Booths </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
              ...
              <ul class="dropdown-menu profile-dropdown" role="menu">
                ...
                <li><a href="#"><i class="pg-signals"></i> Help</a>
                   ...
                   <li class="bg-master-lighter">  
                       <A HREF="javascript:goNewWin()" onClick="javascript:window.close();" class="clearfix">
                  khkjhk
                  </a>
                </li>
                 <li class="bg-master-lighter">  
                  <a href="javascript:goNewWin()" onclick="self.close()" class="clearfix"> 
