          ...
          <div class="col-sm-12 col-sm-height col-middle">
             ...
             <div class="col-md-70">
                <div class="padding-30">
                    <form action="/Exhibition/exhibitorRepresentativeEditContactInfo" method="post" role="form">
                        <%  
                        try
                        {
                            String id=request.getParameter("myid1");
                            HttpSession ss=request.getSession();
                            ss.setAttribute("exhRepId",id);
                            //Database one time Connectivity
                            Connection con;
                            con=dbConnection.getConnection();
                            Statement stat=con.createStatement();
                            ResultSet rs=stat.executeQuery("select * from exhibitorRepresentative where id='"+id+"'");
                            if(!rs.next())
                            {
                                out.print("Sorry");
                            }
                         ...
                         %>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group form-group-default required">
                                     ...
                                     <input type="text" value="<%out.print(rs.getString(4));%>" name="fname" class="form-control"  required>
                                </div>
                                </div>
                                <div class="col-sm-6">
                                 <div class="form-group form-group-default required">
                                     <label>Last name</label>
                                     <input type="text" name="lname" value="<%out.print(rs.getString(5));%>" class="form-control" required >
                                </div>
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-sm-12">
                                  <div class="form-group form-group-default required">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="email" value="<%out.print(rs.getString(7));%>" placeholder="" required>
                                  </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-group-default required">
                                     ...
                                     <input type="text"  class="form-control" value="<%out.print(rs.getString(6));%>" name="designation" required>
                                </div>
                            </div>
                            </div>
                        ...
                        <%     
                           ...
                           ResultSet rs6=stat6.executeQuery("select * from country where id='"+rs.getString(14)+"'");
                         %>  
                         <% 
                             while(rs6.next())
                            { 
                                String idd=rs6.getString(1);
                         %>

                            <option value="<%=idd %>"><%out.print(rs6.getString(4));%></option>  
                          <% 
                            }
                         %>
                              ...
                              <option value="<%=phnNo %>"><%out.print(rs4.getString(4));%></option>  
                                      <% 
                                        }
                                      %>
                              </select>
                              ...
                              <input type="text"  onkeypress="return validate(event)" value="<%out.print(rs.getString(8));%>"name="phoneno" maxlength="10" minlength="10" class="form-control" placeholder="" required>
                            </div>
                        ...
                        <%     
                           ...
                           ResultSet rs7=stat7.executeQuery("select * from country where id='"+rs.getString(15)+"'");
                         %>  
                         <% 
                             while(rs7.next())
                            { 
                                String iddd=rs7.getString(1);
                         %>

                            <option value="<%=iddd %>"><%out.print(rs7.getString(4));%></option>  
                          <% 
                            }
                         %>
                                        <optgroup label="<b>Select country :">
                                      ...
                                      <option value="<%=mobileNo %>"><%out.print(rs2.getString(4));%></option>  
                                      <% 
                                        }
                                      %>
                                    </select>
                              ...
                              <input type="text" name="mobileno"  onkeypress="return validate(event)" value="<%out.print(rs.getString(9));%>"maxlength="10" minlength="10" class="form-control" placeholder="" required>
                            </div>
                      ...
                      <label>Select Address</label>
                            <select class="full-width" name="exhibitorAddress" id="exhibitorAddress"  data-init-plugin="select2">
                               
                         <%     
                           Connection con8;
                           con8=dbConnection.getConnection();
                           Statement stat8=con8.createStatement();
                           ResultSet rs8=stat8.executeQuery("select * from exhibitorAddress where id='"+rs.getString(2)+"'");
                         %>  
                         <% 
                           while(rs8.next())
                           { 
                               String iddd=rs8.getString(1);
                         %>

                            <option value="<%=iddd %>"><%out.print(rs8.getString(4));%></option>  
                          <% 
                            }
                         %> 
                           ...
                           <%   
                               ...
                               ResultSet rs3=stat3.executeQuery("select * from exhibitorAddress");
                             %>   
                            ...
                            <optgroup label="Select Address :">
                                <%
                                 while(rs3.next())
                                 {
                                   String smm=rs3.getString(4);
                                   String idsm=rs3.getString(1);

                                %>
                         
                                    <option  value="<%=idsm %>"><%=smm %></option>
                    ...
                    %>
                        ...
                        <button class="btn btn-primary btn-cons m-t-10" type="submit">Submit</button>
                         <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/exhibitorRepresentative.jsp';">Cancel</button> 
                      </div>
                      </div>
                        </div>    
                        </form>
