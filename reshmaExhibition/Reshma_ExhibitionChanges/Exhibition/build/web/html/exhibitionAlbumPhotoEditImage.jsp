...
psmnt.setString(1, "");
 ...
 String val="update exhibitionAlbum_media set exhibitionAlbumId='"+albumId+"' , caption='"+caption+"', mediaId='"+iddsf+"' where id='"+idValid+"' ";
