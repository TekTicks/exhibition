  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
        ...
        Create a pages account. If you have a facebook account, log into it for this process. Sign in with <a href="#" class="text-info">Facebook</a> or <a href="#" class="text-info">Google</a>
          ...
          <br>
              ...
              <form action="/Exhibition/exhibitionSpeakersAddSocialMedia" method="post" role="form" class="p-t-15" id="login" name="login"  >  
                  ...
                  <label> Social Media </label>    
                    ...
                    try { 
                        ...
                        con=dbConnection.getConnection();
                           Statement stat1=con.createStatement();
                           ResultSet rs1=stat1.executeQuery("select * from socialMedia");
                           int count1=0;
                     %>
