          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorCategoryAdd.jsp';"><i class="fa fa-plus"></i> Add Product
                </button>
                      </div>
                </div>
                <div class="clearfix"></div>
              ...
              <div class="panel-body">
               ...
               <table class="table table-hover demo-table-search" id="tableWithSearch">
                  ...
                  <%   
                         ...
                         String productIdd=(String)ss.getAttribute("exhibitorId");
                         Connection con1;
                         con1=dbConnection.getConnection();
                         Statement stat1=con1.createStatement();
                         ResultSet rs1=stat1.executeQuery("select * from exhibitorProductCategory where createdBy='"+productIdd+"'");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             ...
                             <td>
                                <div class="btn-group">
                                <button  type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorCategoryEdit.jsp?cId=<%= kv %>';"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/exhibitorCategoryDelete?cId=<%=kv%>"><i class="fa fa-trash-o"></i> </button>   
                                </div>
                             </td>
