    ...
    <div class="page-content-wrapper ">
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            <div class="row">
                <form ENCTYPE="multipart/form-data" action="/Exhibition/html/ownerProfileContactInfoSaveDemo.jsp" method="post" role="form">
                           ...
                           <div class="col-md-70">
                               <div class="padding-30">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input type="text" class="form-control" data-date-format="yyyy-mm-dd" name="dob"  placeholder="Pick a date" id="datepicker-component2" name="dateOfBirth" value="" required>
                                </div>
                                </div>
                                </div>
                                <div class="row clearfix">    
                                ...
                                <span class="input-group-addon">
                                  ...
                                  <input type="text"  onkeypress="return validate(event)" name="phoneno" maxlength="10" minlength="10" class="form-control" placeholder="" required>
                                </div>
                                <div class="form-group form-group-default input-group required">
                                    <span class="input-group-addon">
                                  ...
                                  <input type="text" name="mobileno"  onkeypress="return validate(event)" maxlength="10" minlength="10" class="form-control" placeholder="" required>
                                </div>
                               <br>
