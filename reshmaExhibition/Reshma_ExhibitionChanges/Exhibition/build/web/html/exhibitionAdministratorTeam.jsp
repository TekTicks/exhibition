         ...
         <div class="content ">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br> 
                    <div class="panel-title"> <h4> View Team Members </h4>
                </div>
                    <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAdministratorAddExhibitionTeam.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                  ...
                  <tbody>
                     ...
                     Connection con;
                       ...
                       out.println("<td class='v-align-middle semi-bold'><p>"+rs1.getString(11)+"</p></td>");
                            ...
                            HttpSession ssy=request.getSession(true);
                            ssy.setAttribute("myid", exid);
