		...
		$("#login").submit(function(){
	       ...
	       // $("#msgbox").removeClass().addClass('myinfo').text('Validating Your Login ').fadeIn(1000);
			this.timer = setTimeout(function () {
				$.ajax({
		          	url: '/Exhibition/exhibitionAddEvent',
		          	data: 'exId=' + $('#exId').val() +'&eventTitle=' + $('#eventTitle').val()+'&description=' + $('#description').val(),
		          	type: 'post',
                                ...
                                if(msg != 'error') // Message Sent, check and redirect
				{
                                          ...
                                          $("#msgbox1").html('data inserted').addClass('myinfo').fadeTo(200,1,function()
			             {
			              ...
			              document.location='/Exhibition/html/exhibitionAdministratorFAQ.jsp';
			             });      
                                    }
                                else
                                {
...
.myerror
{
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="/Exhibition/html/404.html"> Exhibition Speakers  </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
  ...
  </p> --><p><h1><b>Update Exhibition Event..!</b></h1></p>
          <br>
         
              <form action="/Exhibition/exhibitionEditEvent" method="post" enctype="" role="form" class="p-t-15" id="login" name="login"  >  
                     ...
                     <% 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionEvents where id='"+myex_id+"'");  
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="exId" id="exId">
                          <option> <%out.print(rs3.getString("exhibitionId"));%></option> 
                      ...
                      out.print("error" +e); 
                       ...
                       <label>Event Title</label>   
                          <div class="form-group  required">
                            ...
                            <input type="text"   id="eventTitle" name="eventTitle" value="<%out.print(rs3.getString("eventTitle"));%>" class="form-control" required>
                          </div>
                       
                        
                       <label>Description</label>
                      <div class="form-group" required>
                       <textarea class="form-control" id="description" name="description"><%out.print(rs3.getString("description"));%></textarea>
                     ...
                     <% 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con4=dbConnection.getConnection();
                         ...
                         ResultSet rs4=stat4.executeQuery("select * from exhibitionEventsDetail where id='"+myex_id+"'");  
                        ...
                        String startT = rs4.getString("starttime");
                        
                         String endT = rs4.getString("endtime");
    	...
    	try
    	{
    	    time = outFormat.parse(startT);
             time1 = outFormat.parse(endT);
    	...
    	if( time != null )
    	{
    	     myDate = inFormat.format(time);
             myDate1 = inFormat.format(time1);
    	}
                        ...
                        <div class="row">
                         ...
                         <label>  Start Date <span class="input-sm"> <i class="fa fa-calendar"></i>  </span>   </label> 
                         <div style="text-align:right;padding-right:1%; position:relative;">                           
                             <input type="text" class="form-control" data-date-format="yyyy-mm-dd" placeholder="Pick a date" id="datepicker-component2" name="dateOfBirth" value="<%out.print(rs4.getString("date"));%>" required>
                       ...
                       .
                        ...
                        <div class="input-group bootstrap-timepicker">
                         <label> Start time 
                         <i class="pg-clock"></i></label>
                         <input id="timepicker1" type="text" class="form-control" name="timepicker1" value="<%out.print(myDate);%>" >
                        </div>
                      </div>
 ...
 <div class="col-sm-4">
      <div class="input-group bootstrap-timepicker">
           ...
           <label> End time  <i class="pg-clock"></i></label> 
  <input id="timepicker2" type="text" class="form-control" name="timepicker2"  value="<%out.print(myDate1);%>">
     ...
     <%
                   ...
                   %>  
                        ...
                        <br>
                         ...
                         <button class="btn btn-default" type="button" onclick="document.location.href='/Exhibition/html/exhibitionEventView.jsp';">Cancel</button>
