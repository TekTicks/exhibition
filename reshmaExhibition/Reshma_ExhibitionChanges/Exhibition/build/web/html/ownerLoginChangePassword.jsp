    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        ...
        <h2><b> Change Password<b/></h2>
          <!-- START Login Form -->
          <form id="login_frm" class="p-t-15" role="form" action="/Exhibition/OwnerLoginChangePassword1" method="post">
            <div class="form-group form-group-default">
              <label>New Password</label>
              <div class="controls">
                <input type="password" name="password" id="password" minlength="6" placeholder="Enter new password" class="form-control" required>
              </div>
            </div>
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <input type="password" name="cpassword" id="cpassword" minlength="6" placeholder="Enter Confirm password" class="form-control" required>
              </div>
            </div>
              <br>
            ...
            <center>
                ...
                <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="location.href='ownerLogin.jsp'" >cancel</button>
            </center>  
           </div>
          </form>
          <!--END Login Form-->
