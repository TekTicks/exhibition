...
<html>
  ...
  </p> --><p><h1><b>Add Photo..!</b></h1></p>
          <br>
         
              <form action="exhibitionAddPhoto.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                  ...
                  <div class="form-group form-group-default">
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="albumId" id="albumId">
                            
                         <% while(rs1.next())
                         {   
                              String r=rs1.getString(1);
                         %>
                        <option value="<%out.print(r);%>"><%out.print(rs1.getString(3));%></option>
                         <%   
                         }
                        } 
                   catch(Exception e) 
