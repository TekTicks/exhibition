                    ...
                    <form action="/Exhibition/ownerProfileAddressSave" method="post" role="form">
                        ...
                        <div class="form-group-attached">
                            ...
                            <div class="form-group form-group-default required">
                                 ...
                                 <input type="text"  onkeypress="return validate(event)" name="zipcode"id="tin" class="form-control" required>
                            </div>
                            <div class="form-group form-group-default required">
                            ...
                            ResultSet rs2 = stmt2.executeQuery("Select * from country");
                            while(rs2.next())
                            {
                            ...
                            <div class="form-group form-group-default" id="state" >
