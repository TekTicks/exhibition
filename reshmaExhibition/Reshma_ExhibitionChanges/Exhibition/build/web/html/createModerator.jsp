...
<html>
      ...
      <div class="sidebar-menu">
        <!-- BEGIN SIDEBAR MENU ITEMS-->
          ...
          <!--  <span class="details">19 items</span>  -->
            ...
            <ul class="sub-menu">
                 <li class="">
                <a href="/Exhibition/html/404.html">Create Moderators</a>
                <span class="icon-thumbnail">c</span>
              </li>
              <li class="">
                <a href="/Exhibition/html/404.html">Assign Roles</a>
                <span class="icon-thumbnail">c</span>
              </li>
              <li class="">
                <a href="/Exhibition/html/404.html">View Moderator</a>
                <span class="icon-thumbnail">c</span>
              </li>
              <li class="">
                <a href="/Exhibition/html/404.html">Edit Moderator</a>
                <span class="icon-thumbnail">L</span>
              </li>
              <li class="">
                <a href="/Exhibition/html/404.html">Delete Moderator </a>
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="/Exhibition/html/404.html">Exhibition Event</a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
               ...
               <li class="">
                <a href="/Exhibition/html/404.html">Photos/Videos/Blogs</a>
                <span class="icon-thumbnail">M</span>
              </li>
                <li class="">
  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
  ...
  </p> --><p><h1><b>Create Moderators..!</b></h1></p>
          <br>
         
                <form role="form"   class="p-t-15" id="login" name="login" action="/Exhibition/createModerator" method="post">
                
                     <div class="row">
                                 <div class="col-sm-12">
                                       <div class="form-group form-group-default">
                                 <label>Title</label>
                                 <select class="form-control" id="title" name="title" placeholder="Title" data-init-plugin="select2">      
		  ...
		  <div class="form-group">
                   ...
                   <%    
                    try { 
                        ...
                        con=dbConnection.getConnection();
                           ...
                           ResultSet ry=sa1.executeQuery("select * from country ");
                           int cou1=0;
                     %>
                ...
                <div class="col-sm-8">
                  <div class="form-group form-group-default">
                   ...
                   <input type="text" id="phoneNo" maxlength=10 minlength=10  name="phoneNo" class="form-control" value="" required>
                  </div>
                </div>
              </div>
                 <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" id="mobileNo" maxlength=10 minlength=10  name="mobileNo" class="form-control"  value="" required>
                  </div>
                </div>
              </div>
       ...
       <button class="btn btn-primary btn-cons m-t-10" type="submit">Add </button>
       <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/manageModerator.jsp';">Cancel </button>
            </form>
          </div>
        </div>
      </div>
