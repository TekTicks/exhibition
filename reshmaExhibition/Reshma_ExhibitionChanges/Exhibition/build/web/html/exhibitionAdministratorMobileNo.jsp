...
<script src="pages/js/phonenoValidation.js"></script> 
	...
	$(document).ready(function(){
		$("#login_frm").submit(function(){
                  $("#msgbox3").removeClass().addClass('myinfo').text('').fadeOut(0);
        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
         ...
         <form name="login_frm" id="login_frm" action="" method="post" class="p-t-15" >
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                  <input type="text" name="mobileNo" id="mobileNo" maxlength="10" minlength="10" onkeypress="return validate(event)"  placeholder="Enter Mobile No" class="form-control" required >
              </div>	    
            </div> 
