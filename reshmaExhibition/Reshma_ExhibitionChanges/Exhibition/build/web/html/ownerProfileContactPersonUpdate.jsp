      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            <div class="row">
            <form ENCTYPE="multipart/form-data" action="/Exhibition/html/ownerProfileContactPersonUpdateDemo.jsp" method="post" id="contactPersonUpdate" role="form" autocomplete="off">
                    ...
                    <div class="panel-body">
                     ...
                     %>
					  ...
					  <div class="form-group">
						...
						<div>
						<input type="radio" value="0"<%Integer d1=rs.getInt("gender");
                            ...
                            <label for="male">Male</label>
                            <input type="radio" value="1" <%Integer d=rs.getInt("gender"); 
                                   if(d.equals(1)) { 
                              out.print("checked=\"checked\"");     
                              }%> name="gender" id="gender">
                            <label for="female">Female</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control"  value="<%out.print(rs.getString(7));%>" data-date-format="yyyy-mm-dd" name="dob"  placeholder="Pick a date" id="datepicker-component2" name="dateOfBirth" value="" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-default input-group required">
                             ...
                             %>
                                   ...
                                   <option value="<%=id1 %>"><%out.print(rs8.getString(4));%></option>  
                             <% 
                                   }
                             %>
                             ...
                             %>
                                   ...
                                   <option value="<%=id2 %>"><%out.print(rs7.getString(4));%></option>  
                              <% 
                                   }
                             %>
                              </select>
                              ...
                              <input type="text" maxlength="10" minlength="10"  onkeypress="return validate(event)" value="<%out.print(rs.getString(9));%>" name="phoneno" id="phoneno" class="form-control" placeholder="" required>
                        </div>
                        ...
                        <div class="form-group form-group-default input-group required">
                             ...
                             %>
                                   ...
                                   <option value="<%=id2 %>"><%out.print(rs3.getString(4));%></option>  
                              <% 
                                    }
                             %>
                             </select>
                             ...
                             <input type="text" maxlength="10" minlength="10"  onkeypress="return validate(event)" name="mobileno" id="mobileno" value="<%out.print(rs.getString(10));%>" class="form-control" placeholder="" required>
                        </div>
                 </div> 
                            <div id="msgbox1" ></div>     
                            <br>
            ...
            <div class="col-sm-5">
               ...
               %>    
             <img src="images/<%= img_name %>" id="profile" alt="Profile not uploaded" style="width:200px;height:200px"> 
            <%   }
              catch(Exception e)
                {
                   out.print("error" +e);
