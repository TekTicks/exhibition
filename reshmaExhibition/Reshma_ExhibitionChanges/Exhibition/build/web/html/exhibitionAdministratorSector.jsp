         ...
         <div class="content ">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                  <div class="panel-title"> <h4>View Sectors </h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAdministratorAddSector.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
