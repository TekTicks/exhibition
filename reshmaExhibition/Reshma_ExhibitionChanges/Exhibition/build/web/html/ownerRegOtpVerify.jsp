  ...
  <head>
	...
	$(document).ready(function(){
		$("#form-register").submit(function(){
			 ...
			 $("#otpMsgBox").removeClass().addClass('myinfo').text('').fadeOut(0);
			this.timer = setTimeout(function () {
                                ...
                                if(msg != 'error') // Message Sent, check and redirect
				{
                                          ...
                                          $("#otpMsgBox").html('OTP matched Successfully').addClass('myinfo').fadeTo(200,1,function()
			             {
			              ...
			              document.location='/Exhibition/ckvInsert';
                            ...
                            {
                                $("#otpMsgBox").fadeTo(100,1,function() //start fading the messagebox
		                {
          ...
          <div class="col-sm-12 col-sm-height col-middle">
            ...
            <form id="form-register" class="p-t-15" role="form">
                <div class="form-group">
                    ...
                    <input type="text"  id="enteredOTP" name="enteredOTP" maxlength="4"  onkeypress="return validate(event)" class="form-control"  required>
                    <div id="otpMsgBox"></div> 
                </div>
                <br><br>
                <center>
                    <button class="btn btn-primary btn-cons m-t-10" type="submit">Submit</button>
                    <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="location.href='ownerRegistration.jsp'">Cancel</button>
                </center>
            </form>
          </div>
        </div>
