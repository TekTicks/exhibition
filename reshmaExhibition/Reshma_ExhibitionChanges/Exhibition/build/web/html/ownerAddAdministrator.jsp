	...
	$(document).ready(function(){
		$("#login_frm").submit(function(){
			...
			this.timer = setTimeout(function () {
				$.ajax({
		          	url: '/Exhibition/ownerAdminCheck',
		          	data: 'emailid='+ $('#email').val()+'&contact='+ $('#phone').val()+'&uname='+ $('#uname').val()+'&password='+ $('#password').val()+'&ccode='+ $('#prefix').val()+'&exhibitionName='+ exhibitionName,
		          	type: 'post',
				...
				{				// and direct to the success page
					if(msg == 'invalidemail')	
                                        {
					$("#msgbox1").html('Username already exists').addClass('myerror').fadeTo(900,1,function()
			             {
                                            ...
                                            $("#msgbox2").html('Phone number already exists').addClass('myerror').fadeTo(900,1,function()
			             {
			                ...
			                //document.location='ckvOtp.jsp?user='+msg;
                                          ...
                                          $("#msgbox3").html(' emailId and phone number already exists').addClass('myinfo').fadeOut(5000,0.5,function()
			             {
          ...
          <div class="col-sm-12 col-sm-height col-middle">
           ...
           <h3>Pages makes it easy to enjoy what matters the most in your life</h3>
                ...
                <div class="row">
                 <div class="col-sm-12">
                  <div class="form-group form-group-default">
                    ...
                    <input type="email" name="uname" id="uname" placeholder="" class="form-control" required>
                  </div>
            ...
            con=dbConnection.getConnection();
                       ...
                       ResultSet rs1=st1.executeQuery("select * from country");
                     %>  
                     
               
                    
                         <select class="form-control" data-init-plugin="select2" name="mobileCountryId" id="prefix">
                   ...
                   <div class="form-group form-group-default"><label>Contact Number</label> 
                        <input type="text" name="phone" id="phone"  onkeypress="return validate(event)" maxlength="10" minlength="10" class="form-control" placeholder="" required>
