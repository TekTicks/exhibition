        ...
        <ul class="menu-items"> 
          ...
          <li>
           ...
           <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="ownerManageExhibitor.jsp">Manage Exhibitors</a>
                <span class="icon-thumbnail">P</span>
              </li>
           </ul>
          </li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="ownerManageVisitor.jsp">Manage visitors</a>
                <span class="icon-thumbnail">P</span>
              </li>
          ...
          <div class="visible-lg visible-md m-t-10">
            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                  ...
                  <%
                      ...
                      String ownerId1 = (String) ss.getAttribute("ownerId");
                      Statement st0=con0.createStatement();
                      ResultSet rs0=st0.executeQuery("select * from ownerProfile where createdBy='"+ownerId1+"'");
                      int col0=0;
                      while(rs0.next())
                      {
                  %> 
                            <span class="semi-bold"><%out.print(rs0.getString(5));%></span>
                  <%
                          col0++;  
                      }
                  %>
            ...
            <div class="dropdown pull-right">
              <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <%
                    ...
                    String ownerId01 = (String) ss.getAttribute("ownerId");
                    Statement st01=con01.createStatement();
                    ResultSet rs01=st01.executeQuery("select * from ownerProfile where id='"+ownerId01+"'");
                    int cot01=0;
                    while(rs01.next())
                    {
                        HttpSession io=request.getSession(true);
                        String im1=rs01.getString(3);
                ...
                <%
                    ...
                    Connection con02;
                    con02=dbConnection.getConnection();
                    HttpSession io=request.getSession(false);
                    String imNew1=(String)io.getAttribute("imNew");
                    Statement st02=con02.createStatement();
                    ResultSet rs02=st02.executeQuery("select * from media where id='"+imNew1+"'");
                    int cy111=0;
                    while(rs02.next())
                    {
                %>                       
                    <img src="images/<%out.print(rs02.getString("link"));%>" width="32" height="32">
                <%
                    cy111++;  
                    }
                %>
              ...
              <ul class="dropdown-menu profile-dropdown" role="menu">
                ...
                <li class="bg-master-lighter">
                  <a href="ownerLogout.jsp" class="clearfix">
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
                <div class="tab-pane slide-left padding-20" id="tab1">
                  <div class="row row-same-height">
                        ...
                        <!-- START PANEL -->
                        <form ENCTYPE="multipart/form-data" action="/Exhibition/html/ownerProfileDemo.jsp" method="post" role="form" name="form1" id="form1">
                            ...
                            {
                             out.print("eeror ");
                              response.sendRedirect("/Exhibition/html/ownerLogin.jsp");
                            }
                             else
                            ...
                            <div class="form-group form-group-default required">
                              ...
                              <input type="email" name="p_email"  value="<%out.print(rs5.getString(5));%>" id="p_email" class="form-control" disabled>
                            </div>
                            <div class="form-group form-group-default required">
                            ...
                            <div class="form-group form-group-default input-group required">
                              ...
                              <select class="cs-select cs-skin-slide cs-transparent" name="ccodePrimary" id="ccodePrimary" data-init-plugin="cs-select" disabled>
                             ...
                             %>
                                    ...
                                    <option value=""><%out.print(rs2.getString(4));%></option>  
                              <% 
                                }
                             %>
                              ...
                              <input type="text" name="p_contact"  onkeypress="return validate(event)" value="<%out.print(rs5.getString(7));%>" id="p_contact"class="form-control" placeholder="" disabled>
                          </div>
                        ...
                        <input type="text" name="s_contact" onkeypress="return validate(event)"  value="<%out.print(rs5.getString(8));%>"  id="s_contact" class="form-control" placeholder="" >
                        </div>
                        ...
                        <select class="full-width" id="industry" name="industry"data-init-plugin="select2">
          ...
          <%
            ...
            <input name="file" id="file" style="width:300px" type="file" onchange="readProfile(this);">
            </form>
              </div>
            </div>
          </div>
                    ...
                    <div class="container-fluid container-fixed-lg">
                        ...
                        <div class="panel panel-transparent">
                          <div class="panel-heading">
                            ...
                            <div class="pull-right">
                              <div class="col-xs-12">
                                  <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/ownerProfileSocialMedia.jsp';"><i class="fa fa-plus"></i> Add Social Media
                                </button>
                              </div>
                            </div>
                            <div class="clearfix"></div>
                      ...
                      <div class="container-fluid container-fixed-lg">
                        ...
                        <div class="panel panel-transparent">
                          <div class="panel-heading">
                            ...
                            <div class="pull-right">
                              <div class="col-xs-12">
                                <input type="text" id="search-table1" class="form-control pull-right" placeholder="Search">
                              </div>
                            </div>
                            <div class="pull-right">
                              <div class="col-xs-12">
                          ...
                          <div class="panel-body">
                              ...
                              <table class="table table-hover demo-table-search" id="tableWithSearch1">
                                 <%@page import="java.io.*;" %>
                                 <%@page import="java.sql.*;" %>
                                 <%@page import="java.sql.DriverManager;" %>
                                 <thead>
                      ...
                      <div class="container-fluid container-fixed-lg">
                        ...
                        <div class="panel panel-transparent">
                          <div class="panel-heading">
                            ...
                            <div class="pull-right">
                              <div class="col-xs-12">
                                <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/ownerProfileAddContactInfo.jsp';"><i class="fa fa-plus"></i> Add Contact Person
                                </button>
                              </div>
                            </div>
                            <div class="clearfix"></div>
                          ...
                          <div class="panel-body">
                              ...
                              <table class="table table-hover demo-table-search" id="tableWithSearch2">
                                 <%@page import="java.io.*;" %>
                                 <%@page import="java.sql.*;" %>
                                 <%@page import="java.sql.DriverManager;" %>
                                 <thead>
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->                  
    ...
    <script src="assets/js/datatables2.js" type="text/javascript"></script>    
