...
.myerror
{
  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
  ...
  </p> --><p><h1><b>Update Exhibition Album..!</b></h1></p>
          <br>
         
           <form action="exhibitionAlbumPhotoEditImage.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionAlbum_media where id='"+myex_id+"'");  
                         ...
                         {  
                              HttpSession IJ=request.getSession(true);
                               String EA= rs3.getString("exhibitionAlbumId");
                               
                               IJ.setAttribute("EA", EA);
                            String Im= rs3.getString("mediaId");
                        ...
                        <select class="full-width" id="albumId" name="albumId" data-init-plugin="select2">

                        <%      
                               String albumName1=(String)IJ.getAttribute("EA");
                               Connection con8;
                               con8=dbConnection.getConnection();
                               Statement stat8=con8.createStatement();
                               ResultSet rs8=stat8.executeQuery("select * from exhibitionAlbum where id='"+albumName1+"'");
                        %>  
                        <% 
                             while(rs8.next())
                            { 
                        ...
                        %>
                                ...
                                <option value="<%=id %>"><%out.print(rs8.getString(3));%></option>  
                        <% 
                            }
                        %>
                            <optgroup label="Select id :">
                               ...
                               ResultSet rs7=stat7.executeQuery("select * from exhibitionAlbum");
                        %>  
                        <% 
                             while(rs7.next())
                            { 
                        ...
                        %>
                                ...
                                <option value="<%=id1%>"><%out.print(rs7.getString(3));%></option>  
                        <% 
                            }
                        %>
                       ...
                       <div class="form-group form-group-default required">
                        <label>Caption</label>
                        <input type="text"   id="caption" name="caption" value="<%out.print(rs3.getString("caption"));%>" class="form-control" required>
	...
	<img id="tempImg"  src="images/<%out.print(rso.getString("link"));%>" width="125" height="125"> 
 </div>  
             <%
                          cy++;  
                   ...
                   %>  
                         ...
                         <button class="btn btn-success" type="button" onclick="document.location.href='/Exhibition/html/exhibitionAlbumView.jsp';">Cancel</button>
