...
<html>
  ...
  </p> --><p><h1><b>Add Exhibition Speakers..!</b></h1></p>
          <br>
         
              <form action="exhibitionAddSpeakersImage.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                      
                    
                       
                          <div class="form-group form-group-default required">
                            <label>Speakers Name</label>
                            <input type="text"   id="speakersName" name="speakersName" class="form-control" required>
                          </div>
