          ...
          <!--  <span class="details">19 items</span>  -->
           ...
           <li class="">
            <a href="/Exhibition/html/manageModerator.jsp" class="detailed">
              <span class="title">Manage Moderator</span>
          <!--  <span class="details">19 items</span>  -->
            </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success btn-ok" onclick="document.location.href='/Exhibition/exhibitionSpeakersDelete';">Delete</a>
                </div>
            </div>
        </div>
    </div>
     ...
     <div class="modal fade" id="confirm-delete1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-success btn-ok" onclick="document.location.href='/Exhibition/exhibitionSpeakersSocialMediaDelete';">Delete</a>
                </div>
            </div>
        </div>
    </div>
             ...
             <%
              ...
              <ul class="dropdown-menu profile-dropdown" role="menu">
                ...
                <li class="bg-master-lighter">
                  <a href="exhibitionAdministratorLogin.jsp" class="clearfix">
      ...
      <div class="page-content-wrapper ">
         ...
         <div class="content ">
            ...
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>View Exhibition Speakers</span></a>
                </li>
                
                <li class="">
                  <a data-toggle="tab" href="#tab2"><i class="fa fa-truck tab-icon"></i> <span> Exhibition Speaker Social Media </span></a>
                </li>
          ...
          <div class="tab-pane slide-left padding-20" id="tab1">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                    <div class="panel-title"> <h4><b> View Exhibition Speakers </b></h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAddSpeakers.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                    ...
                    <%   
                      ...
                      Connection con;
                        con=dbConnection.getConnection();
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from exhibitionSpeakers");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             <td>
                                 ...
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitionSpeakersEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/exhibitionSpeakersDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i>
                                 </button>
        ...
        $('#confirm-delete').on('show.bs.modal', function(e) {
          ...
          <!-- END CONTAINER FLUID -->
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                    <div class="panel-title"> <h4><b>  Exhibition Speakers Social Media </b></h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAddSpeakersSocialMedia.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                    ...
                    <%   
                      Connection con1;
                        con1=dbConnection.getConnection();
                         ...
                         ResultSet rs2=sta1.executeQuery("select * from exhibitionSpeakersSocialMedia");
                         int count2=0;
                         ...
                         while(rs2.next())
                         {
                            count2++;
                            out.println("<tr>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs2.getString(2)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs2.getString(3)+"</p></td>");
                            out.println("<td class='v-align-middle semi-bold'><p>"+rs2.getString(4)+"</p></td>");
                            
                         
                            String exid=rs2.getString(1);
                           // HttpSession sO=request.getSession(true);
                           // s.setAttribute("myid", exid);
                            //out.print(exid);
                           %>
                             <td>
                                 ...
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitionSpeakersSocialMediaEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/exhibitionSpeakersSocialMediaDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete1"><i class="fa fa-trash-o"></i>
                                 </button>
