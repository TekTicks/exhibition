			...
			this.timer = setTimeout(function () {
                                ...
                                if(msg != 'error') // Message Sent, check and redirect
				{
                                          ...
                                          $("#msgbox1").html('data inserted').addClass('myinfo').fadeTo(200,1,function()
			             {
			              ...
			              document.location='/Exhibition/html/exhibitionAdministratorSocialMedia.jsp';
			             });
...
.myerror
{
  ...
  </p> --><p><h1><b>Add Exhibition Social Media..!</b></h1></p>
          <br>
               ...
               <form id="login" name="login" class="" role="form" action="" method="post">
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="exhibitionId" id="exhibitionId">
                      ...
                      out.print("error" +e); 
                        ...
                        con9=dbConnection.getConnection();
                           ...
                           ResultSet ry9=sa9.executeQuery("select * from media ");
                           int cou1=0;
                         while(ry9.next())
                         { 
