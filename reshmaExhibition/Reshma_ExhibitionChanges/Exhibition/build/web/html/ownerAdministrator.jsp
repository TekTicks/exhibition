          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/ownerAddAdministrator.jsp';"><i class="fa fa-plus"></i> 
              ...
              <div class="panel-body">
               <table class="table table-hover demo-table-search" id="tableWithSearch">
                  ...
                  %>
                             ...
                             <td>
                                 <div class="btn-group">
                                 <button  type="button" class="btn btn-success btn-cons m-b-10" onclick="document.location.href='/Exhibition/html/ownerAdminUpdate.jsp?adminId=<%= adminId %>';"><i class="fa fa-pencil"></i></button>
                                 </div>
                            </td>
