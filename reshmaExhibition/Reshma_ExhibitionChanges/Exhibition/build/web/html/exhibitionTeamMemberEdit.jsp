  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
        ...
        Create a pages account. If you have a facebook account, log into it for this process. Sign in with <a href="#" class="text-info">Facebook</a> or <a href="#" class="text-info">Google</a>
          ...
          <br>
               ...
               <form role="form"   class="p-t-15" id="login" name="login" action="/Exhibition/exhibitionAdministratorTeamMemberEdit" method="post">
       ...
       <button class="btn btn-primary btn-cons m-t-10" type="submit">Update </button>
        <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/exhibitionAdministratorTeam.jsp';"> Cancel </button>
            </form>
          </div>
        </div>
      </div>
