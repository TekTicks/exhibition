  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
        ...
        Create a pages account. If you have a facebook account, log into it for this process. Sign in with <a href="#" class="text-info">Facebook</a> or <a href="#" class="text-info">Google</a>
          ...
          <br>
              ...
              <form action="/Exhibition/exhibitionAlbumEdit" method="post" enctype="" role="form" class="p-t-15" id="login" name="login"  >  
                     <% 
                      try { 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionAlbum where id='"+myex_id+"'");  
                      ...
                      out.print("error" +e); 
                       ...
                       <label>Album Name</label>   
                          <div class="form-group  required">
                            ...
                            <input type="text"   id="albumTitle" name="albumTitle" value="<%out.print(rs3.getString("albumTitle"));%>" class="form-control" required>
                          </div>
