...
.myerror
{
         ...
         <li>
            ...
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
              ...
              <li class="">
               ...
               <li class="">
                <a href="/Exhibition/htmlexhibitionSpeakerView.jsp"> Exhibition Speakers  </a>
                <span class="icon-thumbnail">M</span>
              </li>
               <li class="">
  ...
  </p> --><p><h1><b>Update Moderators...!</b></h1></p>
          <br>
           
               <form role="form"   class="p-t-15" id="login" name="login" action="/Exhibition/moderatorEdit" method="post">
                   ...
                   <% 
                      try { 
                       ...
                       String myex_id=request.getParameter("myid");
                        ...
                        con=dbConnection.getConnection();
                         ...
                         String query="select * from moderator where id= '"+myex_id+" '";
                         ...
                         while(rs.next())
                         {
                            HttpSession CM=request.getSession(true);
                             String phoneCountryId=rs.getString(9);   
                             CM.setAttribute("phoneCountryId", phoneCountryId);
                             String mobileCountryId=rs.getString(10);
                    ...
                    <div class="row">
                                 ...
                                 <select class="form-control" id="title" name="title" placeholder="Title" data-init-plugin="select2">   
                                     <option >    <%out.print(rs.getString("title"));%></option> 
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" id="email" name="email" class="form-control" value="<%out.print(rs.getString("email"));%>" required>
                  </div>
                </div>
              </div>
             ...
             <div class="col-sm-9">
					  <div class="form-group">
						...
						<div>
						<input type="radio" value="0" name="optionyes" id="optionyes" <%Integer d1=rs.getInt("gender");
                            ...
                            <input type="radio" value="1" name="optionyes" id="optionyes" <%Integer d=rs.getInt("gender"); 
                                   if(d.equals(1)) { 
                              out.println("checked=\"checked\"");     
                              }%>>
                   ...
                   <%    
                    try { 
                          String CCM=(String)CM.getAttribute("mobileCountryId");
                           Connection con10;
                        con10=dbConnection.getConnection();
                    ...
                    try { 
                        ...
                        con02=dbConnection.getConnection();
                           Statement sa0=con02.createStatement();
