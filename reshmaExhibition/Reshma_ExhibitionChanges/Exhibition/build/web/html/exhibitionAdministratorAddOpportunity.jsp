  ...
  <div class="page-content-wrapper ">
   ...
   <div class="register-container full-height sm-p-t-30">
      <div class="container-sm-height full-height">
       ...
       <p><h1><b>Add Exhibition Opportunity..!</b></h1></p>
          <br>
         
               <form action="exhibitionAdministratorAddImageData.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="mobileCountryId" id="mobileCountryId">
                         ...
                         <% while(rsy2.next())
                         { 
                           String r1=rsy2.getString(1);
                          
                         %>
                        <option value="<%= r1%>"><%out.print(rsy2.getString(4));%></option>
                         <%   
                         }
                        } 
                   catch(Exception e) 
                    ...
                    try { 
                     ...
                     %>
                        ...
                        <select class="full-width" data-init-plugin="select2" name="contactCountryId" id="contactCountryId">
                         ...
                         <% while(rsy3.next())
                         { 
                           String r2=rsy3.getString(1);   
                         %>
                        <option  value="<%= r2%>"><%out.print(rsy3.getString(4));%></option>
                         <%   
                         }
                        } 
                   catch(Exception e) 
