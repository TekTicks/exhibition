...
<html>
  ...
  </p> --><p><h1><b>Update Exhibition Speakers..!</b></h1></p>
          <br>
         
                              <form  action="/Exhibition/html/exhibitionSpeakersImageEdit.jsp" enctype="multipart/form-data" id="login_frm"  name="login_frm" class="p-t-15" role="form" autocomplete="off" method="post">
                   ...
                   <% 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionSpeakers where id='"+myex_id+"'");  
                         ...
                         {  
                            ...
                            String Im= rs3.getString("profileMediaId");
                  ...
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" id="speakersName" name="speakersName" class="form-control" value="<%out.print(rs3.getString("name"));%>" required>
                  </div>
                
              
                  <div class="form-group form-group-default">
                    <label>Description</label>
                   <textarea class="form-control" id="description" name="description" required><%out.print(rs3.getString("description"));%></textarea>
                </div>
                  ...
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" id="designation" name="designation" class="form-control" value="<%out.print(rs3.getString("designation"));%>" required>
                  </div>
                
             
                  <div class="form-group form-group-default">
                    <label>Qualification</label>
                    <input type="text" id="qualification" name="qualification" class="form-control" value="<%out.print(rs3.getString("qualification"));%>" required>
                  </div>
                 <br>
	...
	<img id="tempImg"  src="images/<%out.print(rso.getString("link"));%>" width="200" height="200"> 
     ...
     <%
       ...
       <button class="btn btn-primary btn-cons m-t-10" type="submit"> Update </button>
          <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/exhibitionSpeakerView.jsp';"> Cancel </button>
