...
<html>
  ...
  </p> --><p><h1><b>Add Speakers Social Media..!</b></h1></p>
          <br>
         
              <form action="/Exhibition/exhibitionSpeakersSocialMediaEdit" method="post" role="form" class="p-t-15" id="login" name="login"  >  
                     ...
                     <% 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionSpeakersSocialMedia where id='"+myex_id+"'");  
                         ...
                         {  
                              HttpSession IJ=request.getSession(true);
                               String EA= rs3.getString("exhibitionSpeakersId");
                               
                               IJ.setAttribute("EA", EA);
                            String Im= rs3.getString("socialMediaId");
                  ...
                  <label>Speaker Name</label>    
                      <%    
                           ...
                           String SN=(String)IJ.getAttribute("EA");
                           Connection con1;
                           con1=dbConnection.getConnection();
                           Statement stat1=con1.createStatement();
                           ResultSet rs1=stat1.executeQuery("select * from exhibitionSpeakersSocialMedia where id='"+SN+"'");
                           int count1=0;
                     %>
                     
                        <select class="full-width" data-init-plugin="select2" name="speakersId" id="speakersId">
                         ...
                         %>
                        <option value="<%out.print(id1);%>"><%out.print(rs1.getString(2));%></option>
                         <%   
                         }
                        %>  
                            <optgroup label="Select id :">
                               ...
                               ResultSet rs7=stat7.executeQuery("select * from exhibitionSpeakers");
                        %>  
                        <% 
                             while(rs7.next())
                            { 
                        ...
                        %>
                                ...
                                <option value="<%=id1%>"><%out.print(rs7.getString(2));%></option>  
                        <% 
                            }
                        %>
                  ...
                  <label> Social Media </label>    
                      <%    
                           String sm=(String)IJ.getAttribute("IM");
                          
                           Connection con2;
                           con2=dbConnection.getConnection();
                           Statement stat2=con2.createStatement();
                           ResultSet rs2=stat2.executeQuery("select * from socialMedia where id='"+sm+"'");
                           int count2=0;
                     %>
                     
                        <select class="full-width" data-init-plugin="select2" name="socialMediaId" id="socialMediaId">
                         ...
                         %>
                        <option value="<%out.print(id1);%>"> <%out.print(rs2.getString(2));%></option>
                         <%   
                         }
                        %>  
                          <optgroup label="Select id :">
                               ...
                               ResultSet rs8=stat8.executeQuery("select * from socialMedia");
                        %>  
                        <% 
                             while(rs8.next())
                            { 
                        ...
                        %>
                                ...
                                <option value="<%=id1%>"> <%out.print(rs8.getString(2));%></option>  
                        <% 
                            }
                        %>
                      ...
                      <div class="form-group form-group-default required">
                        <label>link</label>
                        <input type="text" id="link" name="link" value="<%out.print(rs3.getString("link"));%>" class="form-control" required>
                      </div> <br>
                       <%
                             count++;
                         }              
                   ...
                   %>  
                      ...
                      <div id="msgbox1"></div>       <button class="btn btn-success" type="submit">Add</button>
                         <button class="btn btn-success" type="button" onclick="document.location.href='/Exhibition/html/exhibitionSpeakerView.jsp';">Cancel</button>
