    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
         ...
         <form action="/Exhibition/exhibitorProductEdit" method="post" role="form">
                  ...
                  <div class="col-md-70">
                    <div class="padding-30">
                        ...
                        try
                        {
                            ...
                            ss.setAttribute("pdtId",id);
                            //Database one time Connectivity
                            Connection con;
                            con=dbConnection.getConnection();
                            Statement stat=con.createStatement();
                            ResultSet rs=stat.executeQuery("select * from exhibitorProducts where id='"+id+"'");
                            if(!rs.next())
                            {
                                out.print("Sorry");
                            }
