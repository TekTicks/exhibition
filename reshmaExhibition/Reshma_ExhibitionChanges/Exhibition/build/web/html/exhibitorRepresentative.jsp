          ...
          <div class="container-fluid container-fixed-lg bg-white">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>Contact Info</span></a>
                </li>
        ...
        <div class="tab-pane slide-left padding-20" id="tab1">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorRepresentativeAddContactInfo.jsp';"><i class="fa fa-plus"></i> Add ContactInfo
                    </button>
                  </div>
                </div>
                <div class="clearfix"></div>
                         ...
                         while(rs.next())
                         {
                           ...
                           %>
                             ...
                             <td>
                                 ...
                                 <button  type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorRepresentativeEditContactInfo.jsp?myid1=<%= kv %>';"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/exhibitorRepresentativeAddContactInfoDelete?myid1=<%=kv%>"><i class="fa fa-trash-o"></i>                                 </button>
                                 </div>
                            </td><%
                            out.println(" </tr>");
                        }
...
<div class="tab-pane slide-left padding-20" id="tab2">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorRepresentativeSocialMedia.jsp';"><i class="fa fa-plus"></i> Add SocialMedia
                    </button>
                  </div>
                </div>
                <div class="clearfix"></div>
              ...
              <div class="panel-body">
               ...
               <table  class="table table-striped" id="tableWithSearch">
                  ...
                  <tbody>
                    <%   
                         HttpSession ss1=request.getSession();
                         String idd1=(String)ss.getAttribute("exhibitorId");
                         Connection con1;
                         con1=dbConnection.getConnection();
                         Statement stat1=con1.createStatement();
                         ResultSet rs1=stat1.executeQuery("select a.*,b.* from socialMedia a,exhibitorRepresentativeSocialMedia b where a.id=b.socialMediaId and b.createdBy='"+idd+"'");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             ...
                             <td>
                                 <div class="btn-group">
                                  <!-- passing id of ownerSocailMedia from url-->
                                 <button  type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorRepresentativeSocialMediaEdit.jsp?myid=<%= kv %>';"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/exhibitorRepresentativeSocialMediaDelete1?myid=<%=kv%>"><i class="fa fa-trash-o"></i>                                 </button>
                                 </div>
                            </td><%
                            out.println(" </tr>");
                        }
