...
<html>
  ...
  </p> --><p><h1><b>Update Exhibition Booth..!</b></h1></p>
          <br>
         
                              <form  action="/Exhibition/html/exhibitionBoothImageEdit.jsp" enctype="multipart/form-data" id="login_frm"  name="login_frm" class="form-horizontal" role="form" autocomplete="off" method="post">
                   ...
                   <% 
                      ...
                      ss1.setAttribute("myex_id" , myex_id);
                        ...
                        con3=dbConnection.getConnection();
                         ...
                         ResultSet rs3=stat13.executeQuery("select * from exhibitionBooth where id='"+myex_id+"'");  
                         ...
                         {  
                            ...
                            String Im= rs3.getString("boothMediaId");
              ...
              <div class="row">
                <div class="col-sm-10">
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" id="boothName" name="boothName" class="form-control" value="<%out.print(rs3.getString("boothName"));%>" required>
                  </div>
                </div>
              </div> <br>
              <div class="row">
	...
	<img id="tempImg"  src="images/<%out.print(rso.getString("link"));%>" width="200" height="200"> 
     ...
     <%
       ...
       <button class="btn btn-primary btn-cons m-t-10" type="submit"> Update </button>
          <button class="btn btn-primary btn-cons m-t-10" type="button" onclick="document.location.href='/Exhibition/html/exhibitionBoothView.jsp';"> Cancel </button>
