          ...
          <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>Owner</span></a>
                </li>
                
                <li class="">
                  <a data-toggle="tab" href="#tab2"><i class="fa fa-truck tab-icon"></i> <span>Exhibitor</span></a>
                </li>
                
                  <li class="">
                  <a data-toggle="tab" href="#tab3"><i class="fa fa-truck tab-icon"></i> <span>Administrator</span></a>
                </li>
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
         ...
         <form name="login_frm" id="login_frm" class="p-t-15" >      
            ...
            <!-- END Form Control-->  
                     ...
                     <a href="/Exhibition/html/ownerLoginEmailVerify.jsp" class="text-info small"><font size="2.5">Forgot Password..?</font></a>
<br>
            <br>
            ...
            <br>
            <br>
           <a href="/Exhibition/html/ownerRegistration.jsp" class="text-info small"><font color="black" size="2.5">Not Registered..?</font></a>
...
<div class="tab-pane slide-left padding-20" id="tab2">
             ...
             <script>
        $(document).ready(function(){
		$("#exhibitor_login_frm").submit(function(){
                //remove previous class and add new "myinfo" class
	        $("#msgbox3").removeClass().addClass('myinfo').text('Validating Your Login ').fadeOut(0);
                $("#msgbox1").removeClass().addClass('myinfo').text('Validating Your Login ').fadeOut(0);
			this.timer = setTimeout(function () {
                            $.ajax({
		            url: '/Exhibition/exhibitorLoginCheck',
		            data: 'un='+ $('#login_id').val() +'&pw=' + $('#password').val(),
		            type: 'post',
		   	    success: function(msg){
                                //alert(msg);
                                if(msg != 'ERROR') // Message Sent, check and redirect
				{
                                       if(msg == 'emailinvalid')
                                        ...
                                        else
                                        {
                                          $("#msgbox3").html('Login Verified, Logging in.....').addClass('myinfo').fadeTo(900,1,function()
			                  {
                                            document.location='/Exhibition/html/exhibitorProfile.jsp';
			                    //redirect to secure page
			                   });
                                        }
                                }
			...
			return false;
                    ...
                    <p class="p-t-35"><h2><b>Exhibitor Login</b></h2> 
         <!-- START Login Form -->
         <form name="exhibitor_login_frm" id="login_frm" class="p-t-15" >      
            <div class="form-group form-group-default">
                <label>Email</label>
                <div class="controls">
                    <input type="email" name="login_id" id="login_id" placeholder="Enter Email Id" class="form-control" required>
...
<br>
 ...
 <!----------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="tab-pane slide-left padding-20" id="tab3">
                    ...
                    <p class="p-t-35"><h2><b>admin Login</b></h2> 
         <!-- START Login Form -->
         <form name="login_frm" id="login_frm" class="p-t-15" >      
            <div class="form-group form-group-default">
                <label>Email</label>
