...
<!--  <body class="fixed-header "> -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success btn-ok" onclick="document.location.href='/Exhibition/moderatorDelete';">Delete</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>Moderators</span></a>
                </li>
                
                <li class="">
                  <a data-toggle="tab" href="#tab2"><i class="fa fa-truck tab-icon"></i> <span>Assign roles & responsiblities</span></a>
                </li>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/createModerator.jsp';"><i class="fa fa-plus"></i> Create Moderators
                    </button>
                  </div>
                </div>
                   <div class="pull-right">
                    ...
                    <%    
                       Connection con;
                        con=dbConnection.getConnection();
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from moderator");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           sO.setAttribute("myid", exid); 
                   // out.print(exid);
                           %>
                             <td>
                                 <div class="btn-group">
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/moderatorEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/moderatorDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i>
                                 </button>
                                 </div>
                            </td><%
                            out.println(" </tr>");
   ...
   <div class="tab-pane slide-left padding-20" id="tab2">
                  <div class="row row-same-height">
                      ...
                      <!-- START PANEL -->
                     <form ENCTYPE="multipart/form-data" action="" method="" role="form" name="form1" id="form1">
                
                           
                            <div class="form-group form-group-default disabled">
                               <label>User Name</label>
                               <input type="email" name="uname" value="" class="form-control" value="You can put anything here" disabled>
                            </div>                  
                            <div class="form-group form-group-default required">
                              <label>Company Name</label>
                              <input type="text" value="" name="cname" id="cname" class="form-control" required>
                            </div>
                         
                          <div class="form-group form-group-default required">
                              <label>Primary Email</label>
                              <input type="email" name="p_email"  value="" id="p_email" class="form-control" required>
                            </div>
                          
                          <div class="form-group form-group-default required">
                              <label>Secondary Email</label>
                              <input type="email" name="s_email" value="" id="s_email" class="form-control" required>
                            </div>
                           ...
                           <div class="form-group form-group-default input-group required">
                            ...
                            <select class="cs-select cs-skin-slide cs-transparent" name="ccodePrimary" id="ccodePrimary" data-init-plugin="cs-select" disabled>
                              ...
                              <input type="text" name="p_contact"  onkeypress="return validate(event)" value="" id="p_contact" maxlength="10" minlength="10" class="form-control" placeholder="" disabled>
                          </div>
                        ...
                        <input type="text" name="s_contact" maxlength="10"  onkeypress="return validate(event)"  minlength="10" value=""  id="s_contact" class="form-control" placeholder="" >
                        </div>
                        ...
                        <div class="form-group form-group-default required">
                          <label>Website</label>
                          <input type="text" value="" name="website" id="website"  class="form-control" required>
                        </div>
           ...
           <div class="col-md-5 b-r b-dashed b-grey ">
            ...
            <img src="" id="profile" alt="Profile not uploaded" style="width:250px;height:250px"> 
