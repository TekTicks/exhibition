    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
         ...
         <form action="/Exhibition/exhibitorRepresentativeSocialMediaEdit" method="post" role="form">
                ...
                <div class="panel panel-transparent">
                  ...
                  <div class="col-md-70">
                    <div class="padding-30">
                        ...
                        try
                        {
                            //Retrieved myid from ownerProfile through URL
                            String id=request.getParameter("myid");
                            HttpSession ss=request.getSession();
                            ss.setAttribute("exhRepSocialMedia1",id);
                            //Database one time Connectivity
                            Connection con;
                            con=dbConnection.getConnection();
                            Statement stat=con.createStatement();
                            ResultSet rs=stat.executeQuery("select a.*,b.* from socialMedia a,exhibitorRepresentativeSocialMedia b where a.id=b.socialMediaId and b.id='"+id+"'");
                            if(!rs.next())
                            {
                                out.print("Sorry");
                            }
                            ...
                            {
                               String exhRepId=rs.getString(8);
                    %>
                       ...
                       <div class="form-group form-group-default required">
                             ...
                             <%   
                               ...
                               ResultSet rs2=stat2.executeQuery("select * from exhibitorRepresentative where id='"+exhRepId+"'");
                             %>   
                            <label> Select Representative</label>
                            <select class="full-width" name="representative" id="representative"  data-init-plugin="select2">
                                <%
                                 while(rs2.next())
                                 {
                                   String smm=rs2.getString(4);
                                   String idsm=rs2.getString(1);

                                %>
                                     <optgroup label=''><option  value="<%=idsm %>"><%=smm %></option></optgroup>
                      ...
                      <div class="form-group form-group-default required">
                            ...
                            <br>
                              <div class="form-group form-group-default required">
                                    ...
                                    <input type="text" name="representativeSocialmedialink" value="<%out.print(rs.getString(10));%>" id="representativeSocialmedialink" class="form-control" required>
                              </div>
                              <br> <%
                        }      
                           }
