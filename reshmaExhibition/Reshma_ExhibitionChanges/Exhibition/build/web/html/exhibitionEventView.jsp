         ...
         <div class="content ">
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading"> <br>
                    <div class="panel-title"> <h4><b> View Exhibition Events </b></h4>
                </div>
                     <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitionAddEvent.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="pull-right">
                    ...
                    <%   
                      ...
                      Connection con;
                        con=dbConnection.getConnection();
                         ...
                         ResultSet rs1=stat1.executeQuery("select * from exhibitionEvents");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             <td>
                                 ...
                                 <button type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitionEventEdit.jsp?myid=<%=exid%>';"><i class="fa fa-pencil"></i></button> 
                                 
                                 <button type="button" class="btn btn-success" data-href="/Exhibition/exhibitionEventDelete?myid=<%=exid%>" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i>
                                 </button>
