...
<html>
  ...
  <!--          <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
  ...
  </p> --><p><h1><b>Add Exhibition Sectors..!</b></h1></p>
          <br>
         
              <form action="exhibitionAdministratorSectorAddImageData.jsp" method="post" enctype="multipart/form-data" role="form" class="p-t-15" id="login" name="login"  >  
	...
	<img id="tempImg"  src="" width="125" height="125"> 
                      ...
                      <div id="msgbox1"></div>       <button class="btn btn-success" type="submit">Add</button>
                         <button class="btn btn-success" type="button" onclick="document.location.href='/Exhibition/html/exhibitionAdministratorSector.jsp';">Cancel</button>
