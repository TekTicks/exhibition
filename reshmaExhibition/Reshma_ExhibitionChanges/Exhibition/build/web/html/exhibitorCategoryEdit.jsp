    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
         ...
         <form action="/Exhibition/exhibitorCategoryEdit" method="post" role="form">
                  ...
                  <div class="col-md-70">
                    <div class="padding-30">
                        ...
                        try
                        {
                            ...
                            ss.setAttribute("catId",id);
                            //Database one time Connectivity
                            Connection con;
                            con=dbConnection.getConnection();
                            Statement stat=con.createStatement();
                            ResultSet rs=stat.executeQuery("select * from exhibitorProductCategory where id='"+id+"'");
                            if(!rs.next())
                            {
                                out.print("Sorry");
                            }
                    ...
                    %>
                        <br>
                              <div class="form-group required">
                                    ...
                                    <input type="text" value="<%out.print(rs.getString(2));%>" name="pName" id="pName" class="form-control" required>
                              </div>
                        
                                <div class="form-group required">
                                <label>Description</label>
                                <div class="wysiwyg5-wrapper b-a b-grey">
                                <textarea id="wysiwyg5"  class="wysiwyg demo-form-wysiwyg" name="desc" placeholder="Enter text ..."><%out.print(rs.getString(3));%></textarea>
                                </div>
                                </div>
                              <br>
                              <br>
                    ...
                    %>
                              ...
                              <button class="btn btn-primary btn-cons m-t-10" onclick="document.location.href='/Exhibition/html/exhibitorProduct.jsp';"> Cancel</button> 
                          </div>
                          </div>    
