		...
		$("#profile").submit(function(){
	       ...
	       // $("#msgbox").removeClass().addClass('myinfo').text('Validating Your Login ').fadeIn(1000);
			...
			this.timer = setTimeout(function () {
				$.ajax({
		          	url: '/Exhibition/ownerEditExhibition',
                                ...
                                if(msg != 'error') // Message Sent, check and redirect
				{
                                          ...
                                          $("#msgbox1").html('Exhibition Updated successfully....!!').addClass('myinfo').fadeTo(1500,1,function()
			             {
			...
			return false;
                 ...
                 <%  
                              try{
                               ...
                               ss.setAttribute("id1",id);//used in ownerEditExhibition.java
                               //Database one time Connectivity
                               Connection con;
                               con=dbConnection.getConnection();
                               Statement stat=con.createStatement();
                               ResultSet rs=stat.executeQuery("select * from exhibition where id='"+id+"'");
                          %>
                          <%
                             if(!rs.next())
                            {
             ...
             <div class="tab-pane slide-right padding-20" >
                 ...
                 <h1> Enter Exhibition name </h1><br>
                  ...
                  <div class="input-group"> 
                      ...
                      <input type="text" id="exhibitionName" value="<%out.print(rs.getString(2));%>" placeholder="Exhibition name" class="form-control">
                  </div>
                      <br><br>
