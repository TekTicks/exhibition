...
out.print("dfdkjfks");
 PreparedStatement ps=con2.prepareStatement("insert into exhibitionBooth(boothName,boothMediaId,description,createdBy,modifiedBy)  values (?,'"+iddsf+"',?,'"+idValid+"','"+idValid+"')");
                        ...
                        else
                        {
                            ...
                            response.sendRedirect("/Exhibition/html/exhibitionBoothView.jsp");
}
catch(Exception e){
