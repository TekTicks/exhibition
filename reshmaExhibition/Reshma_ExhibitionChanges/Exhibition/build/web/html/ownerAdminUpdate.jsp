           ...
           <h3>Pages makes it easy to enjoy what matters the most in your life</h3>
            ...
            <form name="login_frm" action="/Exhibition/ownerAdminUpdate" method="post" id="login_frm" class="p-t-15"  >
                ...
                <div class="row">
                 <div class="col-sm-12">
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" name="uname" id="uname" placeholder=""  value="<%out.print(username);%>" class="form-control" disabled>
                    <div id="msgbox"></div> 
                  </div>
                 </div>
                </div>
                ...
                <div class="form-group form-group-default input-group">
                    ...
                    <select class="cs-select cs-skin-slide cs-transparent" name="prefix" id="prefix" data-init-plugin="cs-select">
                   <%     
                           Connection con6;
                           con6=dbConnection.getConnection();
                           Statement stat6=con6.createStatement();
                           ResultSet rs6=stat6.executeQuery("select * from country where id='"+sm+"'");
                         %>  
                         <% 
                             while(rs6.next())
                         ...
                         %>
                            ...
                            <option value="<%=id2 %>"><%out.print(rs6.getString(4));%></option>  
                          <% 
                            }
                         %>
                        ...
                        %>
                           ...
                           <option  value="<%=id3 %>"><%out.print(rs3.getString(4));%></option>                                     
                        <% 
                           }
                        %>
                    </select>
                    ...
                    <input type="tel" name="phone" id="phone"  onkeypress="return validate(event)" value="<%out.print(mobileNo);%>" maxlength="10" minlength="10" class="form-control" placeholder="" required>
                ...
                <div class="form-group form-group-default required">
                     ...
                     %>   
                        ...
                        %>  
                             <optgroup label=''><option value="<%out.print(rs1.getString(1));%>" ><%=sm %></option></optgroup>
                             <% } %>
                           ...
                           <optgroup label="Select Exhibition :">
                               ...
                               <% while(rs2.next())
                                { 
                               %>
                               <option value="<%out.print(rs2.getString(14));%>"><%out.print(rs2.getString(15));%></option>
                               <% 
                                 }
                               %>  </optgroup> 
