  ...
  <body class="fixed-header   ">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items"> 
          ...
          <li class="">
            <a href="exhibitorProfile.jsp" class="detailed">
           ...
           <li class="">
            <a href="exhibitorRepresentative.jsp" class="detailed">
           ...
           <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="exhibitorProduct.jsp">Products</a>
                <span class="icon-thumbnail">P</span>
              </li>
               <li class="">
                <a href="exhibitorCategory.jsp">category</a>
                <span class="icon-thumbnail">P</span>
              </li>
           ...
           <li class="">
            ...
            <span class="icon-thumbnail">P</span>
             ...
             <li class="">
            <a href="404.html" class="detailed">
          ...
          <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab1"><i class="fa fa-truck tab-icon"></i> <span>Exhibitor Profile</span></a>
                </li>
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab3"><i class="fa fa-truck tab-icon"></i> <span>Contact Information</span></a>
                </li>
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
                 <div class="tab-pane slide-left padding-20" id="tab1">
                  <div class="row row-same-height">
                      ...
                      <!-- START PANEL -->
                     <form ENCTYPE="multipart/form-data" action="/Exhibition/html/exhibitorProfileDemo.jsp" method="post" role="form" name="form1" id="form1">
                            ...
                            <% 
                               try 
                               {
                                   ...
                                   ResultSet rs5=stat5.executeQuery("select a.*,b.* from exhibitorProfile a, exhibitor b  where a.createdBy='"+idd+"'");
                            %>
                            <%
                             if(!rs5.next())
                            {
                            ...
                            { 
                                   String logoMediaID=rs5.getString(2);
                                   String sm=rs5.getString(13);
                                   String sm1=rs5.getString(14);
                                   ss.setAttribute("logoMedia",logoMediaID);
                            %>
                          ...
                          <div class="form-group form-group-default required">
                           ...
                           <div class="form-group form-group-default input-group required">
                            ...
                            <select class="cs-select cs-skin-slide cs-transparent" name="ccodePrimary" id="ccodePrimary" data-init-plugin="cs-select" >
                             ...
                             %>
                                    ...
                                    <option value="<%=id1 %>"><%out.print(rs2.getString(4));%></option>  
                              <% 
                                }
                             %>
                           ...
                           %>  
                            <% while(rs4.next())
                            { String id2=rs4.getString(1);
                           %>
                          </optgroup>
                              <option value="<%=id2 %>"><%out.print(rs4.getString(4));%></option>  
                          <% 
                            }
                          %>
                          </select>
                              ...
                              <input type="text" name="p_contact"  value="<%out.print(rs5.getString(6));%>" id="p_contact" maxlength="10" minlength="10" class="form-control" placeholder="" >
                          </div>
                            
                            
                        <div class="form-group form-group-default input-group ">
                        <span class="input-group-addon">
                        <select class="cs-select cs-skin-slide cs-transparent" id="ccodeSecondary"  name="ccodeSecondary"  data-init-plugin="cs-select">
                        ...
                        <%     
                         ...
                         %>
                            ...
                            <option value="<%=id %>"><%out.print(rs6.getString(4));%></option>  
                          <% 
                            }
                         %>
                        ...
                        %>
                           ...
                           <option  value="<%=id %>"><%out.print(rs3.getString(4));%></option>                                     
                        <% 
                           }
                        %>
                        </select>
                        ...
                        <div class="form-group form-group-default required">
                          <label>About</label>
                          <textarea class="form-control" name="about"  id="about"  placeholder="Briefly Describe your Abilities" required><%out.print(rs5.getString(3));%></textarea>
                        </div> 
                              
                        <div class="form-group form-group-default required">
                          <label>Website</label>
                          <input type="text" value="<%out.print(rs5.getString(8));%>" name="website" id="website"  class="form-control" required>
                        </div>
          ...
          <%
            ...
            ResultSet rs=stat.executeQuery("select * from media  where id='"+logId+"'");
            ...
            <img src="images/<%= img_name %>" id="profile" alt="Profile not uploaded" style="width:250px;height:250px"> 
            <%   }
              catch(Exception e)
                {
                   out.print("error" +e);
...
<div class="tab-pane slide-left padding-20" id="tab2">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <div class="col-xs-12">
                      <button id="show-modal" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/html/exhibitorProfileSocialMedia.jsp';"><i class="fa fa-plus"></i> Add 
                    </button>
                  </div>
                </div>
                <div class="clearfix"></div>
               ...
               <table class="table table-hover demo-table-search" id="tableWithSearch">
                  ...
                  <tbody>
                    <%   
                         ...
                         ResultSet rs1=stat1.executeQuery("select a.*,b.* from socialMedia a,exhibitorSocialMedia b where a.id=b.socialMediaId and b.createdBy='"+idd+"'");
                         int count1=0;
                         ...
                         while(rs1.next())
                         {
                           ...
                           %>
                             ...
                             <td>
                                 ...
                                 <button  type="button" class="btn btn-success" onclick="document.location.href='/Exhibition/html/exhibitorProfileSocialMediaEdit.jsp?myid=<%= kv %>';"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirm-delete" data-href="/Exhibition/exhibitorProfileSocialMediaDeleter?myid=<%=kv%>"><i class="fa fa-trash-o"></i>                                 </button>
                                 </div>
                            </td><%
                            out.println(" </tr>");
                        }
    ...
    <div class="tab-pane slide-left padding-20" id="tab3">
     <div class="register-container full-height sm-p-t-30">
      ...
      document.getElementById("city").innerHTML=xmlHttp.responseText   
                ...
                <form id="form-work" action="/Exhibition/exhibitorProfileAddressSave" method="post"  class="form-horizontal" role="form" autocomplete="off">
                    
                      <%
                            HttpSession ss1=request.getSession();
                            String idd11=(String)ss1.getAttribute("exhibitorId");
                            ...
                            ResultSet rs=stat.executeQuery("select * from exhibitorAddress where createdBy='"+idd11+"'");
                            while(rs.next())
                            {
                              String id1=rs.getString(1);
                              String title=rs.getString(2);
                              String primary1=rs.getString(3);
                              String address1=rs.getString(4);
                              String address2=rs.getString(5);
                              String landmark=rs.getString(6);
                              String maplink=rs.getString(9);
                              String pincode=rs.getString(7);
                              String cityId=rs.getString(8);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="fname" name="title" value="<%out.print(title);%>"   placeholder="Home/Office" name="name" required>
                        </div> 
                         <input type="checkbox" <%Integer d1=rs.getInt("primary1");
                        ...
                        <label for="male">Primary</label>
                    </div>
 
                      <div class="form-group">
                        <label for="position" class="col-sm-3 control-label">Address 1</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="address1" value="<%out.print(address1);%>" id="position" placeholder="Designation" required>
                        </div>
                      </div>
                    
                    <div class="form-group">
                        <label for="position" class="col-sm-3 control-label">Address 2</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="address2" value="<%out.print(address2);%>" id="position" placeholder="Designation" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <p>Enter 6 Digit Pincode Related to your Area. To know?</p>
                          <p class="hint-text small">Click Here .</p>
                          <div class="row">
                           
                            <div class="col-sm-5 sm-m-t-10">
                              <input type="text"  name="zipcode"maxlength="6" minlength="6" onkeypress="return validamaxlete(event)"  value="<%out.print(pincode);%>"   placeholder="Code/Number" class="form-control">
                            </div>
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label for="position" class="col-sm-3 control-label">Landmark</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="landmark"  value="<%out.print(landmark);%>" id="position" placeholder="Designation" required>
                        </div>
                      </div>
                    
                    <div class="form-group">
                        <label for="position" class="col-sm-3 control-label">Map Link</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="maplink"id="tin"  value="<%out.print(maplink);%>" placeholder="Designation" required>
                        </div>
                      </div>
                            ...
                            <label for="country" class="col-sm-3 control-label">Country</label>
                                <div class="col-sm-9">
                               <select class="full-width" id="country" name='country'  onchange="showState(this.value)" data-init-plugin="select2" required>
                                <%
                                String idStateExProfile=(String)ss.getAttribute("idState1");
                                Connection con2;
                                con2=dbConnection.getConnection();
                                Statement stmt2 = con2.createStatement();  
                                ResultSet rs2 = stmt2.executeQuery("Select * from country where id=(select countrytId from state where id='"+idStateExProfile+"')");
                                 while(rs2.next()){
                                     String idCountry=rs2.getString(1);
                                     %>
                                      <option><%out.print(rs2.getString(2));%></option>  
                             ...
                             <%
                                Connection con3;
                                 ...
                                 ResultSet rs3 = stmt3.executeQuery("Select * from country");
                                 while(rs3.next()){
                                     String idCountry=rs3.getString(1);
                                     %>
                                      <option value="<%=idCountry%>"><%out.print(rs3.getString(2));%></option>  
                                      <%
                                 }
                                     %>
                                      </select> 
                    ...
                    <label for="state" class="col-sm-3 control-label">State</label>
                        <div class="col-sm-9">
                            <div id='state'> 
                                <select  class="full-width" id="state" name='state' data-init-plugin="select2" >  
                                <%   
                                Connection con4;
                                  con4=dbConnection.getConnection();
                                 Statement stmt4 = con4.createStatement();  
                                 ResultSet rs4 = stmt4.executeQuery("Select * from state where id=(select citytid from city where id='"+cityId+"')");
                                 while(rs4.next()){
                                     String idState2=rs4.getString(1);
                                      String idStateExPro=rs4.getString(3);
                                       ss.setAttribute("idState1",idState2);
                                     %>
                                      <option value="<%=idState2%>"><%out.print(rs4.getString(2));%></option>  
                                      <%
                                 }
                                     %>
      <option value='-1'></option>  
        ...
        <div class="form-group   ">
             <label for="city" class="col-sm-3 control-label">city</label>
                        <div class="col-sm-9">
            <div id='city'> 
                 <select class="full-width" id="city" name='city' data-init-plugin="select2">  
          
                          <%
                                Connection con5;
                                  con5=dbConnection.getConnection();
                                 Statement stmt5 = con5.createStatement();  
                                 ResultSet rs5 = stmt5.executeQuery("Select * from city where id='"+cityId+"'");
                                 while(rs5.next()){
                                     String idCountry=rs5.getString(1);
                                     %>
                                <option value="<%=idCountry%>"><%out.print(rs5.getString(2));%></option>  
                           <%
                                 }
                           %>
                     <option value='-1'></option>  
                ...
                <% }%> 
                              ...
                              <button class="btn btn-primary btn-cons m-t-10"type="button" onclick="document.location.href='/Exhibition/html/exhibitorProfile.jsp';"> Cancel</button> 
                              </div>
                          </div>    
                        </form>
...
<!----------------------------------------------------------------------------------------------------------------------------------------------------->                  
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <script>
        $('#confirm-delete').on('show.bs.modal', function(e) {
           ...
           // var a=document.getElementById($(this).find('.btn-ok'));
           // alert(a);
           var a=document.getElementById("exhibitionId");     
     });
    </script> 
    <!-- END OVERLAY -->
    <!-- BEGIN VENDOR JS -->
    ...
    <script src="assets/js/datatables1.js" type="text/javascript"></script>
