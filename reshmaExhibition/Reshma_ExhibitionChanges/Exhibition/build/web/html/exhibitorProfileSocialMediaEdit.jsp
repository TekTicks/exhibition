    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
         ...
         <form action="/Exhibition/exhibitorProfileSocialMediaUpdate" method="post" role="form">
                  ...
                  <div class="col-md-70">
                    ...
                    <%  
                        try
                        {
                            ...
                            ResultSet rs=stat.executeQuery("select a.*,b.* from socialMedia a,exhibitorSocialMedia b where a.id=b.socialMediaId and b.id='"+id+"'");
                            if(!rs.next())
                            {
                                out.print("Sorry");
                            }
                    ...
                    %>
                            ...
                            <div class="form-group form-group-default required">
                                ...
                                <input type="text" value="<%out.print(rs.getString(9));%>" name="exhibitorSocialmedialink" id="tin" class="form-control" required>
                            </div>
                    <%
                        }      
                           }
