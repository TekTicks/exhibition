                           ...
                           <div class="form-group-attached">
                                ...
                                <div class="form-group form-group-default required">
                                    <label>Zip Code</label>
                                      <input type="text" name="zipcode"id="tin" onkeypress="return validate(event)" maxlength="6" minlength="6" value="<%out.print(pincode);%>"  class="form-control" required>
                                </div>
                                ...
                                <%String idState1=(String)ss.getAttribute("idState");
                                Connection con2;
                                con2=dbConnection.getConnection();
                                Statement stmt2 = con2.createStatement();  
                                ResultSet rs2 = stmt2.executeQuery("Select * from country where id=(select countrytId from state where id='"+idState1+"')");
                                while(rs2.next()){
                            ...
                            <div class="form-group form-group-default" id="state"  required>
                            ...
                            <select  class="full-width" name='state' data-init-plugin="select2" >  
                                <%   
                                 ...
                                 while(rs4.next()){
                                        ...
                                        String idState=rs4.getString(3);
                                        ss.setAttribute("idState",idState);
                                %>
                                        <option value="<%=idState%>"><%out.print(rs4.getString(2));%></option>  
                                <%
                                 }
                                %>
                            ...
                            <label>Select city</label>
                             <div id='city'>  
                            <select class="full-width" name='city' data-init-plugin="select2">  
