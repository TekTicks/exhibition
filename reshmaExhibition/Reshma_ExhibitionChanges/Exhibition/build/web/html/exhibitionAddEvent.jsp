...
.myerror
{
  ...
  </p> --><p><h1><b>Add Exhibition Event..!</b></h1></p>
          <br>
         
              <form action="/Exhibition/exhibitionAddEvent" method="post" enctype="" role="form" class="p-t-15" id="login" name="login"  >  
 ...
 <div class="col-sm-4">
  ...
  <input id="timepicker2" type="text" class="form-control" name="timepicker2">
