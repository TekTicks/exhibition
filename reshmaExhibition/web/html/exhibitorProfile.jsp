<%-- 
    Document   : exhibitorProfile
    Created on : Jan 27, 2016, 5:59:50 PM
    Author     : Admin
--%>
          ...
          <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                <li class="active">
                  <a data-toggle="tab" href="#tab1"> <span>Personal Info</span></a>
                </li>
                <li class="">
                  <a data-toggle="tab" href="#tab2"> <span>Contact Info</span></a>
                </li>
                <li class="">
                    <a data-toggle="tab" href="#tab3"><span> Social Media</span></a>
                </li>
               <!-- <li class="">
                  ...
                  <div class="row row-same-height">
                    <div class="col-md-5 b-r b-dashed b-grey sm-b-b">
                      <div class="padding-30 m-t-50">
                        ...
                        <h2>Your Personal information will be displyed here soon..</h2>
