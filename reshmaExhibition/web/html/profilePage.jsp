...
<div class="col-md-6">
                ...
                <div class="panel panel-default">
                  ...
                  <form role="form" action="profilePageDb.jsp" method="post">
                      ...
                      <br>
                      <div class="col-sm-9">
                          <button class="btn btn-success" type="submit" onclick="profilePageDb.jsp">Save</button>
...
<div class="col-md-6">
                ...
                Contact 
                  ...
                  <form role="form" action="profilePageContact.jsp" method="post">
                      <div class="form-group">
                        <label>Title</label>
                        <span class="help"></span>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" id="phoneNo" name="phoneNo" class="form-control" required>
                         ...
                         <div class="col-sm-9">
                          <button class="btn btn-success" type="submit" onclick="profilePageContact.jsp">Save</button>
                          <button class="btn btn-default"> Clear</button>
                        </div>
