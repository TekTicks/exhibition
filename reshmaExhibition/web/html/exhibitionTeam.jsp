<%-- 
    Document   : exhibitionTeam
    Created on : Jan 27, 2016, 5:03:57 PM
    Author     : Admin
--%>
  ...
  <div class="page-content-wrapper ">
   ...
   <div class="content ">
       ...
       <div class="panel-body">
         <form role="form" action="exhibitionTeamInsertDb.jsp" method="post">
             ...
             <br>
               <button class="btn btn-success" type="submit" onclick="exhibitionTeamInsertDb.jsp">Add</button>
