              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <!--  <h3>Create Moderator</h3> -->
                    ...
                    <p class="small hint-text">
                      <br></p>
                    <form id="login_frm" class="form-horizontal" role="form" autocomplete="off" action="/Exhibition/ExhibitionAdminPersonal" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="lastName" placeholder="last name" name="lastName" required>
                           ...
                           <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Gender</label>
                        <div class="col-sm-9">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="dateOfBirth" placeholder="DOB" name="dateOfBirth" required>
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="degination" placeholder="designation" name="degination" required>
                        </div>
                      </div>
                     <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Phone No</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="phoneNo" placeholder="phone no" name="phoneNo" required>
                        </div>
                      </div>
                   
                        <div class="form-group">
                        <label for="designation" class="col-sm-3 control-label">Created By</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="email" placeholder="created by" name="email" required>
                        </div> 
                      </div> 
                        <div class="form-group">
                        <label for="fname" class="col-sm-3 control-label">Modified By</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="userName" placeholder="modified by" name="userName" required>
                        </div>
                      </div>
                      ...
                      <!--    <p>I hereby certify that the information above is true and accurate. </p> -->
                        ...
                        <div class="col-sm-9">
                          <button class="btn btn-success" type="submit" onclick="/Exhibition/ExhibitionAdminPersonal">Save</button>
