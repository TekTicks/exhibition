 ...
 <script type="text/javascript">
          ...
          var generatedOTP = 1234;
                ...
                if(generatedOTP==enteredOTP)
                {
			                 ...
			                 $(this).html('OTP Match').removeClass().addClass('myerror').fadeTo(900,1);
                                         document.location='/Exhibition/html/exhibitionAdministratorFogotPassword.jsp?user='+msg;
                                      });
                ...
                else
                {
                	$("#msgbox3").fadeTo(200,0.1,function() //start fading the messagebox
                                        {
			                  //add message and change the class of the box and start fading
			                 $(this).html('OTP does not match').removeClass().addClass('myerror').fadeTo(900,1);
                                         document.location='/Exhibition/html/receiveOTP.jsp?user='+msg;
                                      });
    ...
    <div class="bg-pic">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            <h1> <center> OTP </center></h1> <br> <br>
          
          <!-- START Login Form -->
          <form id="login_frm" class="p-t-15" role="form" action="/Exhibition/ReceiveOTPSession">
            <!-- START Form Control-->
            <div class="form-group form-group-default">
            
              <div class="controls">
              <input type="text" class="form-control" name="mobileNo" placeholder="Enter Mobile Number" id="mobileNo" style="text-align: center" required>
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
            <input type="text" class="form-control" id="enteredOTP" name="enteredOTP" placeholder="Enter OTP" style="text-align: center"required>
            ...
            <!-- END Form Control-->
            <center>     <button class="btn btn-primary btn-cons m-t-10" type="submit" onclick="phoneCheck();check()" >Reset</button>
            </center>  
