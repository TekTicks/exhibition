...
try{
 ...
 String Logo=(String)ss.getAttribute("socialMediaLogo");
  ...
  con=dbConnection.getConnection();
                ...
                PreparedStatement ps1=con.prepareStatement("insert into ownerSocialMedia(socialMediaId,link,createdBy,modifiedBy,iconMediaId)values((select id from socialMedia where socialMedia=?),?,(select id from exhibitor where id='"+21+"'),(select id from exhibitor where id='"+21+"'),(select id from media where id='"+Logo+"'))");
