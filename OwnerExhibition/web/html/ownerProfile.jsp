                  ...
                  <div class="row row-same-height">
                    ...
                    <div class="col-md-7">
                      <div class="padding-30">
                        <form action="ownerProfileSave" method="post" role="form">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <form action="ckvRepresentativeSave.jsp" method="post" id="form-project" role="form" autocomplete="off">
                        <p style="color:blueviolet"><b>Basic Information</b></p>
                            <div class="form-group form-group-default required">
                              <label>Title</label>
                        ...
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                            ...
                            <p style="color:blueviolet"><b>Other Information</b></p>
                                   <div class="row">
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group form-group-default required">
                              ...
                              <input id="start-date" type="text" class="form-control date" name="startDate"  prequired>
                            </div>
                          </div>
                        </div>
                             <div class="row clearfix">    
                        ...
                        <div class="form-group form-group-default input-group required">
                              ...
                              <input type="text" name="p_contact" class="form-control" placeholder="" required>
                            </div>
