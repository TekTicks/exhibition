  ...
  <head>
    ...
    window.onload = function()
    {
     ...
     <script type="text/javascript">
                ...
                {
                    alert("wrong");
                   document.location='/Exhibition/html/exhibitionAdministratorForgotPassword.jsp';
                }
      ...
      <div class="login-container bg-white">
        ...
        <!--     <label>Password</label> -->
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <input type="text" class="form-control" id="confirmpassword" name="confirmpassword" placeholder="Confirm Password" style="text-align: center" required>
              </div> 
            </div> </div> </div>   <br>
             ...
             <div class="col-md-5 no-padding"> 
                ...
                <div class="col-md-6 no-padding"> 
                    <button class="btn btn-primary btn-cons m-t-10" type="submit" onclick="checkPassword()">Update</button> 
