...
psmnt.setString(1, "");
 ...
 PreparedStatement ps=con.prepareStatement("update ownerProfile a,ownerIndustry b set a.name=?,a.primEmail=?,a.secEmail=?,a.secContact=?,a.secCountryCodeId=?,a.about=?, a.website=?,b.industryId=?,logoMediaId=? where a.createdBy='"+idd+"' ");
