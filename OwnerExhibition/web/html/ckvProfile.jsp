          ...
          <div class="container-fluid container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab2"><i class="fa fa-truck tab-icon"></i> <span>Company Info</span></a>
                </li>
                ...
                <li class="">
                  <a data-toggle="tab" href="#tab4"><i class="fa fa-truck tab-icon"></i> <span>Representative</span></a>
                </li>
                  ...
                  <div class="row row-same-height">
                    ...
                    <div class="col-md-7">
                      <div class="padding-30">
                        <form action="ckvProfileSave.jsp" method="post" role="form">
                          ...
                          <div class="form-group form-group-default required">
                            ...
                            <div class="form-group form-group-default required">
                              <label>About</label>
                               <input type="text" name="about" class="form-control" placeholder="Current address" required>
                            ...
                            <div class="form-group form-group-default input-group">
                              ...
                              <input type="text" name="p_contact" class="form-control" placeholder="For verification purpose">
                            </div>
            ...
            <div class="row">
              <div class="col-sm-5">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Represntatives
                    </div>
                  </div>
                  <div class="panel-body">
                    <h3>Keep in Touch
              ...
              <div class="col-sm-7">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <form action="ckvRepresentativeSave.jsp" method="post" id="form-project" role="form" autocomplete="off">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <p class="m-t-10">Other Information</p>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" value="0" name="optionyes" id="male">
                                <label for="male">Male</label>
                                <input type="radio" checked="checked" value="1" name="optionyes" id="female">
                      ...
                      <input type="date" name="dateofbirth" id="date" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="mobileno" id="tin" class="form-control">
                    </div>
