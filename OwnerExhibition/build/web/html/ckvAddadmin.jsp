    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li class="">
            <a href="http://pages.revox.io/dashboard/2.1.0/html/widget.html" class="detailed">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <form id="form-personal" role="form" autocomplete="off">
                      ...
                      <div class="clearfix"></div>
                      <button class="btn btn-primary" type="submit">Create a new Admin</button>
                    </form>
                  </div>
                </div>
                <!-- END PANEL -->
              ...
              <div class="col-lg-5 col-md-6">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Add Administrator
                    </div>
                  </div>
                  <div class="panel-body">
