         ...
         try
            {
                ...
                PreparedStatement ps1=con.prepareStatement("insert into ownerSocialMedia(socialMediaId,link,createdBy,modifiedBy,iconMediaId)values((select id from socialMedia where socialMedia=?),?,(select id from owner where id='"+id+"'),(select id from owner where id='"+id+"'),(select id from media where id='"+mediaId+"'))");
