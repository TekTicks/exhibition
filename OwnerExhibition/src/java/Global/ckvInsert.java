...
public class ckvInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            ps.setString(1, Global.global.email1);
            ps.setString(2, Global.global.password1);
            ps.setInt(3, 1);
            ps.setInt(4, 1);
            ps.executeUpdate();
            ...
            ps1.setString(1,Global.global.cname1);
            ps1.setString(2,"");
            ps1.setString(3,Global.global.email1);
            ps1.setString(4,"");
            ps1.setString(5,Global.global.contact1);
            ps1.setString(6,"");
            ps1.setString(7,"");
            ps1.executeUpdate();
