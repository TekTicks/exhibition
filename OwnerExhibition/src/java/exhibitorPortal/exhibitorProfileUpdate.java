...
public class exhibitorProfileUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {   
                           ...
                           // String ccode =request.getParameter("ccodePrimary");
                            ...
                            PreparedStatement ps=con.prepareStatement("update exhibitorProfile a, set a.primEmail=?,a.secEmail=?,a.primContact=?,a.secContact=?,a.secCountryCodeId=?,a.about=?, a.website=? where a.createdBy='"+1+"' ");
                                 
                            ps.setString(1, p_email);
                            ps.setString(2, s_email);
                            ps.setString(3, p_contact);
