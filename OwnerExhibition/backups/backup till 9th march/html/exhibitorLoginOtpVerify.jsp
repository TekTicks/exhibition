		...
		$("#otpPage").submit(function(){
			...
			this.timer = setTimeout(function () {
                                ...
                                if(msg != 'error') // Message Sent, check and redirect
				{
                                          ...
                                          $("#msgbox1").html('Otp matches').addClass('myinfo').fadeTo(1500,1,function()
			             {
			                 //redirect to secure page
			              document.location='/Exhibition/html/exhibitorLoginChangePassword.jsp';
			             });
        ...
        <h2><b> OTP Generation<b/></h2>
          ...
          <form id="otpPage" class="p-t-15" role="form">
            ...
            <center>
                ...
                <button class="btn btn-primary btn-cons m-t-10" onclick="location.href='exhibitorLogin.jsp'" >cancel</button>
            </center>
          </form>
          <!--END Login Form-->
      </div>
