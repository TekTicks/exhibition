              ...
              <div class="panel-body">
               ...
               <table class="table table-hover demo-table-search" id="tableWithSearch">
                  ...
                  %>
                     ...
                     <button type="button" class="btn btn-primary btn-cons" onclick="document.location.href='/Exhibition/ownerAdminDelete?adminId=<%= adminId %>';" data-dismiss="modal">Continue</button>
