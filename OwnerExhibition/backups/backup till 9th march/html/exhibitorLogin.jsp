...
<html>
  <head>
   ...
   <body class="fixed-header   ">
        ...
        <img src="assets/img/demo/exhibitors.jpg" alt="" class="lazy">
        <!-- END Background Pic-->
         </div>
         ...
         <form name="login_frm" id="login_frm" class="p-t-15" >
            ...
            <!-- END Form Control-->  
                ...
                <a href="/Exhibition/html/exhibitorLoginEmailVerify.jsp" class="text-info small"><font size="2.5"><b>Forgot Password..?</font></a>
