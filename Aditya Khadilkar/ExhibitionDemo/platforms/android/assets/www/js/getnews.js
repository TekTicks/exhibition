 ...
 */
  $('#newsOutput').append('<a href="eachNews.html"  class="item-link close-panel" id="'+newsid[i]+'" onclick="geteachnews(this)"><div class="card demo-card-header-pic"><div style="background-image:url('+imageLink[i]+')" valign="bottom" class="card-header color-white no-border"></div><div class="card-content"> <div class="card-content-inner"> <p class="color-gray"><h3>'+newsTitle[i]+'</h3></p><p><span>Author:- </span>'+author[i]+'</p></div></div></div> </a>');
	...
	var data = {"news":[{"typeId":typeId,"newsId":newsId}]};
		var sendData = function(data)
		{
				...
				var photoLink=[];
						...
						for(i=0;i<n;i++)
						{
	$('#getOutput').append('<div class="card ks-facebook-card"><div class="card-header">  <div class="ks-facebook-avatar" id="imageNews"><img src="data:image/(png|jpg);base64,'+photoLink[i]+'" width="34" height="34" class="lazy"/></div> <div class="ks-facebook-name" style="text-align:left;" id="nameNews" >'+name[i]+'</div><div class="ks-facebook-date" style="text-align:left;" id="dateTime">'+createdOn[i]+'</div></div><div class="card-content"> <div class="card-content-inner"><p style="text-align:left;word-wrap:break-word;" id="datanews">'+comment[i]+'</p></div></div></div>');
						}
...
//	var NoOflikes= localStorage.getItem("NoOflikes");
  ...
  $('#getOutput').prepend('<div class="card ks-facebook-card"><div class="card-header">  <div class="ks-facebook-avatar" id="imageNews"><img src="data:image/(png|jpg);base64,'+profileImage+'" width="34" height="34" class="lazy"/></div> <div class="ks-facebook-name" style="text-align:left;" id="nameNews" >'+profileName+'</div><div class="ks-facebook-date" style="text-align:left;" id="dateTime">'+date+'</div> </div><div class="card-content"> <div class="card-content-inner"><p style="text-align:left;word-wrap:break-word;" id="datanews">'+comment+'</p></div></div></div>');
